...
`;function er(){const l=Sn(),[o,u]=k.useState(!1);return a.jsx(nj,{children:a.jsxs(ij,{children:[a.jsx(Gu,{to:"/",onClick:()=>u(!1),children:a.jsxs(aj,{children:[a.jsx(lj,{src:tj,alt:"SCKW Logo"}),a.jsx(rj,{children:"SC Konstanz-Wollmatingen e. V."})]})}),a.jsxs(oj,{"aria-label":"Menü öffnen/schließen","aria-expanded":o,"aria-controls":"mobile-nav",onClick:()=>u(h=>!h),children:["Menü",a.jsx("span",{style:{fontSize:"1.25rem",marginLeft:"0.1rem"},children:"☰"})]}),a.jsxs(sj,{id:"mobile-nav",$open:o,children:[a.jsx(Gu,{to:"/sponsoring",$active:l.pathname==="/sponsoring"||l.pathname==="/sponsoring-v2",onClick:()=>u(!1),children:"🤝 Sponsoring"}),a.jsx(Gu,{to:"/jobs",$active:l.pathname==="/jobs",onClick:()=>u(!1),children:"💼 Jobbörse"}),!1]})]})})}const cj=f.footer`
  width: 100%;
  text-align: center;
  padding: 2rem 1rem;
  font-size: 0.95rem;
...
Herzliche Grüße
`);return`mailto:${kj}?subject=${y}&body=${x}`},h=p=>{const v=p.maxSponsors-(p.sponsors?.length||0);return{availableSlots:v,isFullyBooked:v===0}},m=l.filter(p=>!p.title.includes("Platz-Renovierung"));return a.jsx(hj,{children:m.map((p,v)=>{const{isFullyBooked:y}=h(p),x=o(p.status),E=x==="vergeben"||y,w=y?"vergeben":x,H=p.keyBenefits||[];return a.jsxs(mj,{isVergeben:E,children:[a.jsxs(gj,{children:[a.jsx(pj,{children:u(p.title)}),a.jsx(xj,{children:p.title.replace(new RegExp("^(\\p{Emoji_Presentation}|\\p{Extended_Pictographic}|[\\u2600-\\u27BF])\\s*","u"),"").trim()}),!E&&a.jsx(bj,{children:p.price}),a.jsx(yj,{status:w,children:w==="vergeben"?"✅ Vergeben":"🟩 Verfügbar"})]}),E&&p.sponsors&&p.sponsors.length>0?a.jsxs(_j,{children:[p.sponsors[0].image&&a.jsx(Ej,{src:`/sponsors/${p.sponsors[0].image}`,alt:p.sponsors[0].name}),a.jsx(Tj,{children:p.sponsors[0].name}),a.jsxs(Aj,{children:["Hauptsponsor seit ",p.sponsors[0].since]}),p.sponsors[0].website&&a.jsx(Cj,{href:p.sponsors[0].website,target:"_blank",rel:"noopener noreferrer",children:"🔗 Website besuchen"})]}):a.jsx(vj,{children:H.map((Y,R)=>a.jsxs(jj,{isHighlight:Y.highlight,children:[a.jsx(Sj,{children:Y.icon}),a.jsx(wj,{children:Y.text})]},R))}),a.jsx(zj,{href:E?void 0:c(p.title),isVergeben:E,children:E?"Vergeben":"Jetzt anfragen"})]},v)})})}const Mj=f.div`
  margin: 2rem 0;
  border-radius: 12px;
...
`,Kz=f.img`
  max-width: ${l=>l.$scale*100}%;
  max-height: ${l=>l.$scale*100}%;
  object-fit: contain;
`,$z=f.div`
  width: 100%;
