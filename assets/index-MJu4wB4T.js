 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var h0;function vx(){return h0||(h0=1,function(l){function s(C,q){var P=C.length;C.push(q);e:for(;0<P;){var ue=P-1>>>1,y=C[ue];if(0<d(y,q))C[ue]=q,C[P]=y,P=ue;else break e}}function c(C){return C.length===0?null:C[0]}function u(C){if(C.length===0)return null;var q=C[0],P=C.pop();if(P!==q){C[0]=P;e:for(var ue=0,y=C.length,N=y>>>1;ue<N;){var Y=2*(ue+1)-1,V=C[Y],F=Y+1,ce=C[F];if(0>d(V,P))F<y&&0>d(ce,V)?(C[ue]=ce,C[F]=P,ue=F):(C[ue]=V,C[Y]=P,ue=Y);else if(F<y&&0>d(ce,P))C[ue]=ce,C[F]=P,ue=F;else break e}}return q}function d(C,q){var P=C.sortIndex-q.sortIndex;return P!==0?P:C.id-q.id}if(l.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var g=performance;l.unstable_now=function(){return g.now()}}else{var b=Date,j=b.now();l.unstable_now=function(){return b.now()-j}}var v=[],p=[],E=1,R=null,M=3,H=!1,L=!1,G=!1,X=!1,U=typeof setTimeout=="function"?setTimeout:null,J=typeof clearTimeout=="function"?clearTimeout:null,Q=typeof setImmediate<"u"?setImmediate:null;function ae(C){for(var q=c(p);q!==null;){if(q.callback===null)u(p);else if(q.startTime<=C)u(p),q.sortIndex=q.expirationTime,s(v,q);else break;q=c(p)}}function Z(C){if(G=!1,ae(C),!L)if(c(v)!==null)L=!0,le||(le=!0,Ye());else{var q=c(p);q!==null&&qe(Z,q.startTime-C)}}var le=!1,W=-1,Ee=5,we=-1;function at(){return X?!0:!(l.unstable_now()-we<Ee)}function it(){if(X=!1,le){var C=l.unstable_now();we=C;var q=!0;try{e:{L=!1,G&&(G=!1,J(W),W=-1),H=!0;var P=M;try{t:{for(ae(C),R=c(v);R!==null&&!(R.expirationTime>C&&at());){var ue=R.callback;if(typeof ue=="function"){R.callback=null,M=R.priorityLevel;var y=ue(R.expirationTime<=C);if(C=l.unstable_now(),typeof y=="function"){R.callback=y,ae(C),q=!0;break t}R===c(v)&&u(v),ae(C)}else u(v);R=c(v)}if(R!==null)q=!0;else{var N=c(p);N!==null&&qe(Z,N.startTime-C),q=!1}}break e}finally{R=null,M=P,H=!1}q=void 0}}finally{q?Ye():le=!1}}}var Ye;if(typeof Q=="function")Ye=function(){Q(it)};else if(typeof MessageChannel<"u"){var Zt=new MessageChannel,Kt=Zt.port2;Zt.port1.onmessage=it,Ye=function(){Kt.postMessage(null)}}else Ye=function(){U(it,0)};function qe(C,q){W=U(function(){C(l.unstable_now())},q)}l.unstable_IdlePriority=5,l.unstable_ImmediatePriority=1,l.unstable_LowPriority=4,l.unstable_NormalPriority=3,l.unstable_Profiling=null,l.unstable_UserBlockingPriority=2,l.unstable_cancelCallback=function(C){C.callback=null},l.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ee=0<C?Math.floor(1e3/C):5},l.unstable_getCurrentPriorityLevel=function(){return M},l.unstable_next=function(C){switch(M){case 1:case 2:case 3:var q=3;break;default:q=M}var P=M;M=q;try{return C()}finally{M=P}},l.unstable_requestPaint=function(){X=!0},l.unstable_runWithPriority=function(C,q){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var P=M;M=C;try{return q()}finally{M=P}},l.unstable_scheduleCallback=function(C,q,P){var ue=l.unstable_now();switch(typeof P=="object"&&P!==null?(P=P.delay,P=typeof P=="number"&&0<P?ue+P:ue):P=ue,C){case 1:var y=-1;break;case 2:y=250;break;case 5:y=1073741823;break;case 4:y=1e4;break;default:y=5e3}return y=P+y,C={id:E++,callback:q,priorityLevel:C,startTime:P,expirationTime:y,sortIndex:-1},P>ue?(C.sortIndex=P,s(p,C),c(v)===null&&C===c(p)&&(G?(J(W),W=-1):G=!0,qe(Z,P-ue))):(C.sortIndex=y,s(v,C),L||H||(L=!0,le||(le=!0,Ye()))),C},l.unstable_shouldYield=at,l.unstable_wrapCallback=function(C){var q=M;return function(){var P=M;M=q;try{return C.apply(this,arguments)}finally{M=P}}}}(Zu)),Zu}var m0;function yx(){return m0||(m0=1,Qu.exports=vx()),Qu.exports}var Ku={exports:{}},tt={};/**
 * @license React
 ...
 *
 * @license MIT
 */var D0="popstate";function Ev(l={}){function s(u,d){let{pathname:g,search:b,hash:j}=u.location;return Wc("",{pathname:g,search:b,hash:j},d.state&&d.state.usr||null,d.state&&d.state.key||"default")}function c(u,d){return typeof d=="string"?d:Ai(d)}return Av(s,c,null,l)}function ke(l,s){if(l===!1||l===null||typeof l>"u")throw new Error(s)}function Nt(l,s){if(!l){typeof console<"u"&&console.warn(s);try{throw new Error(s)}catch{}}}function Tv(){return Math.random().toString(36).substring(2,10)}function B0(l,s){return{usr:l.state,key:l.key,idx:s}}function Wc(l,s,c=null,u){return{pathname:typeof l=="string"?l:l.pathname,search:"",hash:"",...typeof s=="string"?vl(s):s,state:c,key:s&&s.key||u||Tv()}}function Ai({pathname:l="/",search:s="",hash:c=""}){return s&&s!=="?"&&(l+=s.charAt(0)==="?"?s:"?"+s),c&&c!=="#"&&(l+=c.charAt(0)==="#"?c:"#"+c),l}function vl(l){let s={};if(l){let c=l.indexOf("#");c>=0&&(s.hash=l.substring(c),l=l.substring(0,c));let u=l.indexOf("?");u>=0&&(s.search=l.substring(u),l=l.substring(0,u)),l&&(s.pathname=l)}return s}function Av(l,s,c,u={}){let{window:d=document.defaultView,v5Compat:g=!1}=u,b=d.history,j="POP",v=null,p=E();p==null&&(p=0,b.replaceState({...b.state,idx:p},""));function E(){return(b.state||{idx:null}).idx}function R(){j="POP";let X=E(),U=X==null?null:X-p;p=X,v&&v({action:j,location:G.location,delta:U})}function M(X,U){j="PUSH";let J=Wc(G.location,X,U);p=E()+1;let Q=B0(J,p),ae=G.createHref(J);try{b.pushState(Q,"",ae)}catch(Z){if(Z instanceof DOMException&&Z.name==="DataCloneError")throw Z;d.location.assign(ae)}g&&v&&v({action:j,location:G.location,delta:1})}function H(X,U){j="REPLACE";let J=Wc(G.location,X,U);p=E();let Q=B0(J,p),ae=G.createHref(J);b.replaceState(Q,"",ae),g&&v&&v({action:j,location:G.location,delta:0})}function L(X){return Rv(X)}let G={get action(){return j},get location(){return l(d,b)},listen(X){if(v)throw new Error("A history only accepts one active listener");return d.addEventListener(D0,R),v=X,()=>{d.removeEventListener(D0,R),v=null}},createHref(X){return s(d,X)},createURL:L,encodeLocation(X){let U=L(X);return{pathname:U.pathname,search:U.search,hash:U.hash}},push:M,replace:H,go(X){return b.go(X)}};return G}function Rv(l,s=!1){let c="http://localhost";typeof window<"u"&&(c=window.location.origin!=="null"?window.location.origin:window.location.href),ke(c,"No window.location.(origin|href) available to create URL");let u=typeof l=="string"?l:Ai(l);return u=u.replace(/ $/,"%20"),!s&&u.startsWith("//")&&(u=c+u),new URL(u,c)}function Dg(l,s,c="/"){return kv(l,s,c,!1)}function kv(l,s,c,u){let d=typeof s=="string"?vl(s):s,g=hn(d.pathname||"/",c);if(g==null)return null;let b=Bg(l);Mv(b);let j=null;for(let v=0;j==null&&v<b.length;++v){let p=qv(g);j=Gv(b[v],p,u)}return j}function Bg(l,s=[],c=[],u=""){let d=(g,b,j)=>{let v={relativePath:j===void 0?g.path||"":j,caseSensitive:g.caseSensitive===!0,childrenIndex:b,route:g};v.relativePath.startsWith("/")&&(ke(v.relativePath.startsWith(u),`Absolute route path "${v.relativePath}" nested under path "${u}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),v.relativePath=v.relativePath.slice(u.length));let p=dn([u,v.relativePath]),E=c.concat(v);g.children&&g.children.length>0&&(ke(g.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${p}".`),Bg(g.children,s,E,p)),!(g.path==null&&!g.index)&&s.push({path:p,score:Hv(p,g.index),routesMeta:E})};return l.forEach((g,b)=>{if(g.path===""||!g.path?.includes("?"))d(g,b);else for(let j of Og(g.path))d(g,b,j)}),s}function Og(l){let s=l.split("/");if(s.length===0)return[];let[c,...u]=s,d=c.endsWith("?"),g=c.replace(/\?$/,"");if(u.length===0)return d?[g,""]:[g];let b=Og(u.join("/")),j=[];return j.push(...b.map(v=>v===""?g:[g,v].join("/"))),d&&j.push(...b),j.map(v=>l.startsWith("/")&&v===""?"/":v)}function Mv(l){l.sort((s,c)=>s.score!==c.score?c.score-s.score:Lv(s.routesMeta.map(u=>u.childrenIndex),c.routesMeta.map(u=>u.childrenIndex)))}var Cv=/^:[\w-]+$/,Dv=3,Bv=2,Ov=1,Nv=10,Uv=-2,O0=l=>l==="*";function Hv(l,s){let c=l.split("/"),u=c.length;return c.some(O0)&&(u+=Uv),s&&(u+=Bv),c.filter(d=>!O0(d)).reduce((d,g)=>d+(Cv.test(g)?Dv:g===""?Ov:Nv),u)}function Lv(l,s){return l.length===s.length&&l.slice(0,-1).every((u,d)=>u===s[d])?l[l.length-1]-s[s.length-1]:0}function Gv(l,s,c=!1){let{routesMeta:u}=l,d={},g="/",b=[];for(let j=0;j<u.length;++j){let v=u[j],p=j===u.length-1,E=g==="/"?s:s.slice(g.length)||"/",R=vo({path:v.relativePath,caseSensitive:v.caseSensitive,end:p},E),M=v.route;if(!R&&p&&c&&!u[u.length-1].route.index&&(R=vo({path:v.relativePath,caseSensitive:v.caseSensitive,end:!1},E)),!R)return null;Object.assign(d,R.params),b.push({params:d,pathname:dn([g,R.pathname]),pathnameBase:Zv(dn([g,R.pathnameBase])),route:M}),R.pathnameBase!=="/"&&(g=dn([g,R.pathnameBase]))}return b}function vo(l,s){typeof l=="string"&&(l={path:l,caseSensitive:!1,end:!0});let[c,u]=Yv(l.path,l.caseSensitive,l.end),d=s.match(c);if(!d)return null;let g=d[0],b=g.replace(/(.)\/+$/,"$1"),j=d.slice(1);return{params:u.reduce((p,{paramName:E,isOptional:R},M)=>{if(E==="*"){let L=j[M]||"";b=g.slice(0,g.length-L.length).replace(/(.)\/+$/,"$1")}const H=j[M];return R&&!H?p[E]=void 0:p[E]=(H||"").replace(/%2F/g,"/"),p},{}),pathname:g,pathnameBase:b,pattern:l}}function Yv(l,s=!1,c=!0){Nt(l==="*"||!l.endsWith("*")||l.endsWith("/*"),`Route path "${l}" will be treated as if it were "${l.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${l.replace(/\*$/,"/*")}".`);let u=[],d="^"+l.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(b,j,v)=>(u.push({paramName:j,isOptional:v!=null}),v?"/?([^\\/]+)?":"/([^\\/]+)"));return l.endsWith("*")?(u.push({paramName:"*"}),d+=l==="*"||l==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):c?d+="\\/*$":l!==""&&l!=="/"&&(d+="(?:(?=\\/|$))"),[new RegExp(d,s?void 0:"i"),u]}function qv(l){try{return l.split("/").map(s=>decodeURIComponent(s).replace(/\//g,"%2F")).join("/")}catch(s){return Nt(!1,`The URL path "${l}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${s}).`),l}}function hn(l,s){if(s==="/")return l;if(!l.toLowerCase().startsWith(s.toLowerCase()))return null;let c=s.endsWith("/")?s.length-1:s.length,u=l.charAt(c);return u&&u!=="/"?null:l.slice(c)||"/"}function Vv(l,s="/"){let{pathname:c,search:u="",hash:d=""}=typeof l=="string"?vl(l):l;return{pathname:c?c.startsWith("/")?c:Xv(c,s):s,search:Kv(u),hash:$v(d)}}function Xv(l,s){let c=s.replace(/\/+$/,"").split("/");return l.split("/").forEach(d=>{d===".."?c.length>1&&c.pop():d!=="."&&c.push(d)}),c.length>1?c.join("/"):"/"}function Pu(l,s,c,u){return`Cannot include a '${l}' character in a manually specified \`to.${s}\` field [${JSON.stringify(u)}].  Please separate it out to the \`to.${c}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function Qv(l){return l.filter((s,c)=>c===0||s.route.path&&s.route.path.length>0)}function lf(l){let s=Qv(l);return s.map((c,u)=>u===s.length-1?c.pathname:c.pathnameBase)}function rf(l,s,c,u=!1){let d;typeof l=="string"?d=vl(l):(d={...l},ke(!d.pathname||!d.pathname.includes("?"),Pu("?","pathname","search",d)),ke(!d.pathname||!d.pathname.includes("#"),Pu("#","pathname","hash",d)),ke(!d.search||!d.search.includes("#"),Pu("#","search","hash",d)));let g=l===""||d.pathname==="",b=g?"/":d.pathname,j;if(b==null)j=c;else{let R=s.length-1;if(!u&&b.startsWith("..")){let M=b.split("/");for(;M[0]==="..";)M.shift(),R-=1;d.pathname=M.join("/")}j=R>=0?s[R]:"/"}let v=Vv(d,j),p=b&&b!=="/"&&b.endsWith("/"),E=(g||b===".")&&c.endsWith("/");return!v.pathname.endsWith("/")&&(p||E)&&(v.pathname+="/"),v}var dn=l=>l.join("/").replace(/\/\/+/g,"/"),Zv=l=>l.replace(/\/+$/,"").replace(/^\/*/,"/"),Kv=l=>!l||l==="?"?"":l.startsWith("?")?l:"?"+l,$v=l=>!l||l==="#"?"":l.startsWith("#")?l:"#"+l;function Jv(l){return l!=null&&typeof l.status=="number"&&typeof l.statusText=="string"&&typeof l.internal=="boolean"&&"data"in l}var Ng=["POST","PUT","PATCH","DELETE"];new Set(Ng);var Wv=["GET",...Ng];new Set(Wv);var yl=k.createContext(null);yl.displayName="DataRouter";var Eo=k.createContext(null);Eo.displayName="DataRouterState";k.createContext(!1);var Ug=k.createContext({isTransitioning:!1});Ug.displayName="ViewTransition";var Fv=k.createContext(new Map);Fv.displayName="Fetchers";var Pv=k.createContext(null);Pv.displayName="Await";var Ut=k.createContext(null);Ut.displayName="Navigation";var Ri=k.createContext(null);Ri.displayName="Location";var Qt=k.createContext({outlet:null,matches:[],isDataRoute:!1});Qt.displayName="Route";var of=k.createContext(null);of.displayName="RouteError";function Iv(l,{relative:s}={}){ke(Sl(),"useHref() may be used only in the context of a <Router> component.");let{basename:c,navigator:u}=k.useContext(Ut),{hash:d,pathname:g,search:b}=ki(l,{relative:s}),j=g;return c!=="/"&&(j=g==="/"?c:dn([c,g])),u.createHref({pathname:j,search:b,hash:d})}function Sl(){return k.useContext(Ri)!=null}function mn(){return ke(Sl(),"useLocation() may be used only in the context of a <Router> component."),k.useContext(Ri).location}var Hg="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Lg(l){k.useContext(Ut).static||k.useLayoutEffect(l)}function Gg(){let{isDataRoute:l}=k.useContext(Qt);return l?dy():ey()}function ey(){ke(Sl(),"useNavigate() may be used only in the context of a <Router> component.");let l=k.useContext(yl),{basename:s,navigator:c}=k.useContext(Ut),{matches:u}=k.useContext(Qt),{pathname:d}=mn(),g=JSON.stringify(lf(u)),b=k.useRef(!1);return Lg(()=>{b.current=!0}),k.useCallback((v,p={})=>{if(Nt(b.current,Hg),!b.current)return;if(typeof v=="number"){c.go(v);return}let E=rf(v,JSON.parse(g),d,p.relative==="path");l==null&&s!=="/"&&(E.pathname=E.pathname==="/"?s:dn([s,E.pathname])),(p.replace?c.replace:c.push)(E,p.state,p)},[s,c,g,d,l])}k.createContext(null);function ki(l,{relative:s}={}){let{matches:c}=k.useContext(Qt),{pathname:u}=mn(),d=JSON.stringify(lf(c));return k.useMemo(()=>rf(l,JSON.parse(d),u,s==="path"),[l,d,u,s])}function ty(l,s){return Yg(l,s)}function Yg(l,s,c,u){ke(Sl(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:d}=k.useContext(Ut),{matches:g}=k.useContext(Qt),b=g[g.length-1],j=b?b.params:{},v=b?b.pathname:"/",p=b?b.pathnameBase:"/",E=b&&b.route;{let U=E&&E.path||"";qg(v,!E||U.endsWith("*")||U.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${v}" (under <Route path="${U}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${U}"> to <Route path="${U==="/"?"*":`${U}/*`}">.`)}let R=mn(),M;if(s){let U=typeof s=="string"?vl(s):s;ke(p==="/"||U.pathname?.startsWith(p),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${p}" but pathname "${U.pathname}" was given in the \`location\` prop.`),M=U}else M=R;let H=M.pathname||"/",L=H;if(p!=="/"){let U=p.replace(/^\//,"").split("/");L="/"+H.replace(/^\//,"").split("/").slice(U.length).join("/")}let G=Dg(l,{pathname:L});Nt(E||G!=null,`No routes matched location "${M.pathname}${M.search}${M.hash}" `),Nt(G==null||G[G.length-1].route.element!==void 0||G[G.length-1].route.Component!==void 0||G[G.length-1].route.lazy!==void 0,`Matched leaf route at location "${M.pathname}${M.search}${M.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let X=ry(G&&G.map(U=>Object.assign({},U,{params:Object.assign({},j,U.params),pathname:dn([p,d.encodeLocation?d.encodeLocation(U.pathname).pathname:U.pathname]),pathnameBase:U.pathnameBase==="/"?p:dn([p,d.encodeLocation?d.encodeLocation(U.pathnameBase).pathname:U.pathnameBase])})),g,c,u);return s&&X?k.createElement(Ri.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...M},navigationType:"POP"}},X):X}function ny(){let l=fy(),s=Jv(l)?`${l.status} ${l.statusText}`:l instanceof Error?l.message:JSON.stringify(l),c=l instanceof Error?l.stack:null,u="rgba(200,200,200, 0.5)",d={padding:"0.5rem",backgroundColor:u},g={padding:"2px 4px",backgroundColor:u},b=null;return console.error("Error handled by React Router default ErrorBoundary:",l),b=k.createElement(k.Fragment,null,k.createElement("p",null,"💿 Hey developer 👋"),k.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",k.createElement("code",{style:g},"ErrorBoundary")," or"," ",k.createElement("code",{style:g},"errorElement")," prop on your route.")),k.createElement(k.Fragment,null,k.createElement("h2",null,"Unexpected Application Error!"),k.createElement("h3",{style:{fontStyle:"italic"}},s),c?k.createElement("pre",{style:d},c):null,b)}var ay=k.createElement(ny,null),ly=class extends k.Component{constructor(l){super(l),this.state={location:l.location,revalidation:l.revalidation,error:l.error}}static getDerivedStateFromError(l){return{error:l}}static getDerivedStateFromProps(l,s){return s.location!==l.location||s.revalidation!=="idle"&&l.revalidation==="idle"?{error:l.error,location:l.location,revalidation:l.revalidation}:{error:l.error!==void 0?l.error:s.error,location:s.location,revalidation:l.revalidation||s.revalidation}}componentDidCatch(l,s){console.error("React Router caught the following error during render",l,s)}render(){return this.state.error!==void 0?k.createElement(Qt.Provider,{value:this.props.routeContext},k.createElement(of.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function iy({routeContext:l,match:s,children:c}){let u=k.useContext(yl);return u&&u.static&&u.staticContext&&(s.route.errorElement||s.route.ErrorBoundary)&&(u.staticContext._deepestRenderedBoundaryId=s.route.id),k.createElement(Qt.Provider,{value:l},c)}function ry(l,s=[],c=null,u=null){if(l==null){if(!c)return null;if(c.errors)l=c.matches;else if(s.length===0&&!c.initialized&&c.matches.length>0)l=c.matches;else return null}let d=l,g=c?.errors;if(g!=null){let v=d.findIndex(p=>p.route.id&&g?.[p.route.id]!==void 0);ke(v>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(g).join(",")}`),d=d.slice(0,Math.min(d.length,v+1))}let b=!1,j=-1;if(c)for(let v=0;v<d.length;v++){let p=d[v];if((p.route.HydrateFallback||p.route.hydrateFallbackElement)&&(j=v),p.route.id){let{loaderData:E,errors:R}=c,M=p.route.loader&&!E.hasOwnProperty(p.route.id)&&(!R||R[p.route.id]===void 0);if(p.route.lazy||M){b=!0,j>=0?d=d.slice(0,j+1):d=[d[0]];break}}}return d.reduceRight((v,p,E)=>{let R,M=!1,H=null,L=null;c&&(R=g&&p.route.id?g[p.route.id]:void 0,H=p.route.errorElement||ay,b&&(j<0&&E===0?(qg("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),M=!0,L=null):j===E&&(M=!0,L=p.route.hydrateFallbackElement||null)));let G=s.concat(d.slice(0,E+1)),X=()=>{let U;return R?U=H:M?U=L:p.route.Component?U=k.createElement(p.route.Component,null):p.route.element?U=p.route.element:U=v,k.createElement(iy,{match:p,routeContext:{outlet:v,matches:G,isDataRoute:c!=null},children:U})};return c&&(p.route.ErrorBoundary||p.route.errorElement||E===0)?k.createElement(ly,{location:c.location,revalidation:c.revalidation,component:H,error:R,children:X(),routeContext:{outlet:null,matches:G,isDataRoute:!0}}):X()},null)}function sf(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function oy(l){let s=k.useContext(yl);return ke(s,sf(l)),s}function sy(l){let s=k.useContext(Eo);return ke(s,sf(l)),s}function uy(l){let s=k.useContext(Qt);return ke(s,sf(l)),s}function uf(l){let s=uy(l),c=s.matches[s.matches.length-1];return ke(c.route.id,`${l} can only be used on routes that contain a unique "id"`),c.route.id}function cy(){return uf("useRouteId")}function fy(){let l=k.useContext(of),s=sy("useRouteError"),c=uf("useRouteError");return l!==void 0?l:s.errors?.[c]}function dy(){let{router:l}=oy("useNavigate"),s=uf("useNavigate"),c=k.useRef(!1);return Lg(()=>{c.current=!0}),k.useCallback(async(d,g={})=>{Nt(c.current,Hg),c.current&&(typeof d=="number"?l.navigate(d):await l.navigate(d,{fromRouteId:s,...g}))},[l,s])}var N0={};function qg(l,s,c){!s&&!N0[l]&&(N0[l]=!0,Nt(!1,c))}k.memo(hy);function hy({routes:l,future:s,state:c}){return Yg(l,void 0,c,s)}function my({to:l,replace:s,state:c,relative:u}){ke(Sl(),"<Navigate> may be used only in the context of a <Router> component.");let{static:d}=k.useContext(Ut);Nt(!d,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:g}=k.useContext(Qt),{pathname:b}=mn(),j=Gg(),v=rf(l,lf(g),b,u==="path"),p=JSON.stringify(v);return k.useEffect(()=>{j(JSON.parse(p),{replace:s,state:c,relative:u})},[j,p,u,s,c]),null}function dl(l){ke(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function gy({basename:l="/",children:s=null,location:c,navigationType:u="POP",navigator:d,static:g=!1}){ke(!Sl(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let b=l.replace(/^\/*/,"/"),j=k.useMemo(()=>({basename:b,navigator:d,static:g,future:{}}),[b,d,g]);typeof c=="string"&&(c=vl(c));let{pathname:v="/",search:p="",hash:E="",state:R=null,key:M="default"}=c,H=k.useMemo(()=>{let L=hn(v,b);return L==null?null:{location:{pathname:L,search:p,hash:E,state:R,key:M},navigationType:u}},[b,v,p,E,R,M,u]);return Nt(H!=null,`<Router basename="${b}"> is not able to match the URL "${v}${p}${E}" because it does not start with the basename, so the <Router> won't render anything.`),H==null?null:k.createElement(Ut.Provider,{value:j},k.createElement(Ri.Provider,{children:s,value:H}))}function py({children:l,location:s}){return ty(Fc(l),s)}function Fc(l,s=[]){let c=[];return k.Children.forEach(l,(u,d)=>{if(!k.isValidElement(u))return;let g=[...s,d];if(u.type===k.Fragment){c.push.apply(c,Fc(u.props.children,g));return}ke(u.type===dl,`[${typeof u.type=="string"?u.type:u.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),ke(!u.props.index||!u.props.children,"An index route cannot have child routes.");let b={id:u.props.id||g.join("-"),caseSensitive:u.props.caseSensitive,element:u.props.element,Component:u.props.Component,index:u.props.index,path:u.props.path,loader:u.props.loader,action:u.props.action,hydrateFallbackElement:u.props.hydrateFallbackElement,HydrateFallback:u.props.HydrateFallback,errorElement:u.props.errorElement,ErrorBoundary:u.props.ErrorBoundary,hasErrorBoundary:u.props.hasErrorBoundary===!0||u.props.ErrorBoundary!=null||u.props.errorElement!=null,shouldRevalidate:u.props.shouldRevalidate,handle:u.props.handle,lazy:u.props.lazy};u.props.children&&(b.children=Fc(u.props.children,g)),c.push(b)}),c}var ho="get",mo="application/x-www-form-urlencoded";function To(l){return l!=null&&typeof l.tagName=="string"}function by(l){return To(l)&&l.tagName.toLowerCase()==="button"}function xy(l){return To(l)&&l.tagName.toLowerCase()==="form"}function vy(l){return To(l)&&l.tagName.toLowerCase()==="input"}function yy(l){return!!(l.metaKey||l.altKey||l.ctrlKey||l.shiftKey)}function Sy(l,s){return l.button===0&&(!s||s==="_self")&&!yy(l)}var Kr=null;function jy(){if(Kr===null)try{new FormData(document.createElement("form"),0),Kr=!1}catch{Kr=!0}return Kr}var wy=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Iu(l){return l!=null&&!wy.has(l)?(Nt(!1,`"${l}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${mo}"`),null):l}function _y(l,s){let c,u,d,g,b;if(xy(l)){let j=l.getAttribute("action");u=j?hn(j,s):null,c=l.getAttribute("method")||ho,d=Iu(l.getAttribute("enctype"))||mo,g=new FormData(l)}else if(by(l)||vy(l)&&(l.type==="submit"||l.type==="image")){let j=l.form;if(j==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let v=l.getAttribute("formaction")||j.getAttribute("action");if(u=v?hn(v,s):null,c=l.getAttribute("formmethod")||j.getAttribute("method")||ho,d=Iu(l.getAttribute("formenctype"))||Iu(j.getAttribute("enctype"))||mo,g=new FormData(j,l),!jy()){let{name:p,type:E,value:R}=l;if(E==="image"){let M=p?`${p}.`:"";g.append(`${M}x`,"0"),g.append(`${M}y`,"0")}else p&&g.append(p,R)}}else{if(To(l))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');c=ho,u=null,d=mo,b=l}return g&&d==="text/plain"&&(b=g,g=void 0),{action:u,method:c.toLowerCase(),encType:d,formData:g,body:b}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function cf(l,s){if(l===!1||l===null||typeof l>"u")throw new Error(s)}function zy(l,s,c){let u=typeof l=="string"?new URL(l,typeof window>"u"?"server://singlefetch/":window.location.origin):l;return u.pathname==="/"?u.pathname=`_root.${c}`:s&&hn(u.pathname,s)==="/"?u.pathname=`${s.replace(/\/$/,"")}/_root.${c}`:u.pathname=`${u.pathname.replace(/\/$/,"")}.${c}`,u}async function Ey(l,s){if(l.id in s)return s[l.id];try{let c=await import(l.module);return s[l.id]=c,c}catch(c){return console.error(`Error loading route module \`${l.module}\`, reloading page...`),console.error(c),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Ty(l){return l==null?!1:l.href==null?l.rel==="preload"&&typeof l.imageSrcSet=="string"&&typeof l.imageSizes=="string":typeof l.rel=="string"&&typeof l.href=="string"}async function Ay(l,s,c){let u=await Promise.all(l.map(async d=>{let g=s.routes[d.route.id];if(g){let b=await Ey(g,c);return b.links?b.links():[]}return[]}));return Cy(u.flat(1).filter(Ty).filter(d=>d.rel==="stylesheet"||d.rel==="preload").map(d=>d.rel==="stylesheet"?{...d,rel:"prefetch",as:"style"}:{...d,rel:"prefetch"}))}function U0(l,s,c,u,d,g){let b=(v,p)=>c[p]?v.route.id!==c[p].route.id:!0,j=(v,p)=>c[p].pathname!==v.pathname||c[p].route.path?.endsWith("*")&&c[p].params["*"]!==v.params["*"];return g==="assets"?s.filter((v,p)=>b(v,p)||j(v,p)):g==="data"?s.filter((v,p)=>{let E=u.routes[v.route.id];if(!E||!E.hasLoader)return!1;if(b(v,p)||j(v,p))return!0;if(v.route.shouldRevalidate){let R=v.route.shouldRevalidate({currentUrl:new URL(d.pathname+d.search+d.hash,window.origin),currentParams:c[0]?.params||{},nextUrl:new URL(l,window.origin),nextParams:v.params,defaultShouldRevalidate:!0});if(typeof R=="boolean")return R}return!0}):[]}function Ry(l,s,{includeHydrateFallback:c}={}){return ky(l.map(u=>{let d=s.routes[u.route.id];if(!d)return[];let g=[d.module];return d.clientActionModule&&(g=g.concat(d.clientActionModule)),d.clientLoaderModule&&(g=g.concat(d.clientLoaderModule)),c&&d.hydrateFallbackModule&&(g=g.concat(d.hydrateFallbackModule)),d.imports&&(g=g.concat(d.imports)),g}).flat(1))}function ky(l){return[...new Set(l)]}function My(l){let s={},c=Object.keys(l).sort();for(let u of c)s[u]=l[u];return s}function Cy(l,s){let c=new Set;return new Set(s),l.reduce((u,d)=>{let g=JSON.stringify(My(d));return c.has(g)||(c.add(g),u.push({key:g,link:d})),u},[])}function Vg(){let l=k.useContext(yl);return cf(l,"You must render this element inside a <DataRouterContext.Provider> element"),l}function Dy(){let l=k.useContext(Eo);return cf(l,"You must render this element inside a <DataRouterStateContext.Provider> element"),l}var ff=k.createContext(void 0);ff.displayName="FrameworkContext";function Xg(){let l=k.useContext(ff);return cf(l,"You must render this element inside a <HydratedRouter> element"),l}function By(l,s){let c=k.useContext(ff),[u,d]=k.useState(!1),[g,b]=k.useState(!1),{onFocus:j,onBlur:v,onMouseEnter:p,onMouseLeave:E,onTouchStart:R}=s,M=k.useRef(null);k.useEffect(()=>{if(l==="render"&&b(!0),l==="viewport"){let G=U=>{U.forEach(J=>{b(J.isIntersecting)})},X=new IntersectionObserver(G,{threshold:.5});return M.current&&X.observe(M.current),()=>{X.disconnect()}}},[l]),k.useEffect(()=>{if(u){let G=setTimeout(()=>{b(!0)},100);return()=>{clearTimeout(G)}}},[u]);let H=()=>{d(!0)},L=()=>{d(!1),b(!1)};return c?l!=="intent"?[g,M,{}]:[g,M,{onFocus:Si(j,H),onBlur:Si(v,L),onMouseEnter:Si(p,H),onMouseLeave:Si(E,L),onTouchStart:Si(R,H)}]:[!1,M,{}]}function Si(l,s){return c=>{l&&l(c),c.defaultPrevented||s(c)}}function Oy({page:l,...s}){let{router:c}=Vg(),u=k.useMemo(()=>Dg(c.routes,l,c.basename),[c.routes,l,c.basename]);return u?k.createElement(Uy,{page:l,matches:u,...s}):null}function Ny(l){let{manifest:s,routeModules:c}=Xg(),[u,d]=k.useState([]);return k.useEffect(()=>{let g=!1;return Ay(l,s,c).then(b=>{g||d(b)}),()=>{g=!0}},[l,s,c]),u}function Uy({page:l,matches:s,...c}){let u=mn(),{manifest:d,routeModules:g}=Xg(),{basename:b}=Vg(),{loaderData:j,matches:v}=Dy(),p=k.useMemo(()=>U0(l,s,v,d,u,"data"),[l,s,v,d,u]),E=k.useMemo(()=>U0(l,s,v,d,u,"assets"),[l,s,v,d,u]),R=k.useMemo(()=>{if(l===u.pathname+u.search+u.hash)return[];let L=new Set,G=!1;if(s.forEach(U=>{let J=d.routes[U.route.id];!J||!J.hasLoader||(!p.some(Q=>Q.route.id===U.route.id)&&U.route.id in j&&g[U.route.id]?.shouldRevalidate||J.hasClientLoader?G=!0:L.add(U.route.id))}),L.size===0)return[];let X=zy(l,b,"data");return G&&L.size>0&&X.searchParams.set("_routes",s.filter(U=>L.has(U.route.id)).map(U=>U.route.id).join(",")),[X.pathname+X.search]},[b,j,u,d,p,s,l,g]),M=k.useMemo(()=>Ry(E,d),[E,d]),H=Ny(E);return k.createElement(k.Fragment,null,R.map(L=>k.createElement("link",{key:L,rel:"prefetch",as:"fetch",href:L,...c})),M.map(L=>k.createElement("link",{key:L,rel:"modulepreload",href:L,...c})),H.map(({key:L,link:G})=>k.createElement("link",{key:L,...G})))}function Hy(...l){return s=>{l.forEach(c=>{typeof c=="function"?c(s):c!=null&&(c.current=s)})}}var Qg=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Qg&&(window.__reactRouterVersion="7.7.1")}catch{}function Ly({basename:l,children:s,window:c}){let u=k.useRef();u.current==null&&(u.current=Ev({window:c,v5Compat:!0}));let d=u.current,[g,b]=k.useState({action:d.action,location:d.location}),j=k.useCallback(v=>{k.startTransition(()=>b(v))},[b]);return k.useLayoutEffect(()=>d.listen(j),[d,j]),k.createElement(gy,{basename:l,children:s,location:g.location,navigationType:g.action,navigator:d})}var Zg=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,df=k.forwardRef(function({onClick:s,discover:c="render",prefetch:u="none",relative:d,reloadDocument:g,replace:b,state:j,target:v,to:p,preventScrollReset:E,viewTransition:R,...M},H){let{basename:L}=k.useContext(Ut),G=typeof p=="string"&&Zg.test(p),X,U=!1;if(typeof p=="string"&&G&&(X=p,Qg))try{let we=new URL(window.location.href),at=p.startsWith("//")?new URL(we.protocol+p):new URL(p),it=hn(at.pathname,L);at.origin===we.origin&&it!=null?p=it+at.search+at.hash:U=!0}catch{Nt(!1,`<Link to="${p}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let J=Iv(p,{relative:d}),[Q,ae,Z]=By(u,M),le=Vy(p,{replace:b,state:j,target:v,preventScrollReset:E,relative:d,viewTransition:R});function W(we){s&&s(we),we.defaultPrevented||le(we)}let Ee=k.createElement("a",{...M,...Z,href:X||J,onClick:U||g?s:W,ref:Hy(H,ae),target:v,"data-discover":!G&&c==="render"?"true":void 0});return Q&&!G?k.createElement(k.Fragment,null,Ee,k.createElement(Oy,{page:J})):Ee});df.displayName="Link";var Gy=k.forwardRef(function({"aria-current":s="page",caseSensitive:c=!1,className:u="",end:d=!1,style:g,to:b,viewTransition:j,children:v,...p},E){let R=ki(b,{relative:p.relative}),M=mn(),H=k.useContext(Eo),{navigator:L,basename:G}=k.useContext(Ut),X=H!=null&&$y(R)&&j===!0,U=L.encodeLocation?L.encodeLocation(R).pathname:R.pathname,J=M.pathname,Q=H&&H.navigation&&H.navigation.location?H.navigation.location.pathname:null;c||(J=J.toLowerCase(),Q=Q?Q.toLowerCase():null,U=U.toLowerCase()),Q&&G&&(Q=hn(Q,G)||Q);const ae=U!=="/"&&U.endsWith("/")?U.length-1:U.length;let Z=J===U||!d&&J.startsWith(U)&&J.charAt(ae)==="/",le=Q!=null&&(Q===U||!d&&Q.startsWith(U)&&Q.charAt(U.length)==="/"),W={isActive:Z,isPending:le,isTransitioning:X},Ee=Z?s:void 0,we;typeof u=="function"?we=u(W):we=[u,Z?"active":null,le?"pending":null,X?"transitioning":null].filter(Boolean).join(" ");let at=typeof g=="function"?g(W):g;return k.createElement(df,{...p,"aria-current":Ee,className:we,ref:E,style:at,to:b,viewTransition:j},typeof v=="function"?v(W):v)});Gy.displayName="NavLink";var Yy=k.forwardRef(({discover:l="render",fetcherKey:s,navigate:c,reloadDocument:u,replace:d,state:g,method:b=ho,action:j,onSubmit:v,relative:p,preventScrollReset:E,viewTransition:R,...M},H)=>{let L=Zy(),G=Ky(j,{relative:p}),X=b.toLowerCase()==="get"?"get":"post",U=typeof j=="string"&&Zg.test(j),J=Q=>{if(v&&v(Q),Q.defaultPrevented)return;Q.preventDefault();let ae=Q.nativeEvent.submitter,Z=ae?.getAttribute("formmethod")||b;L(ae||Q.currentTarget,{fetcherKey:s,method:Z,navigate:c,replace:d,state:g,relative:p,preventScrollReset:E,viewTransition:R})};return k.createElement("form",{ref:H,method:X,action:G,onSubmit:u?v:J,...M,"data-discover":!U&&l==="render"?"true":void 0})});Yy.displayName="Form";function qy(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Kg(l){let s=k.useContext(yl);return ke(s,qy(l)),s}function Vy(l,{target:s,replace:c,state:u,preventScrollReset:d,relative:g,viewTransition:b}={}){let j=Gg(),v=mn(),p=ki(l,{relative:g});return k.useCallback(E=>{if(Sy(E,s)){E.preventDefault();let R=c!==void 0?c:Ai(v)===Ai(p);j(l,{replace:R,state:u,preventScrollReset:d,relative:g,viewTransition:b})}},[v,j,p,c,u,s,l,d,g,b])}var Xy=0,Qy=()=>`__${String(++Xy)}__`;function Zy(){let{router:l}=Kg("useSubmit"),{basename:s}=k.useContext(Ut),c=cy();return k.useCallback(async(u,d={})=>{let{action:g,method:b,encType:j,formData:v,body:p}=_y(u,s);if(d.navigate===!1){let E=d.fetcherKey||Qy();await l.fetch(E,c,d.action||g,{preventScrollReset:d.preventScrollReset,formData:v,body:p,formMethod:d.method||b,formEncType:d.encType||j,flushSync:d.flushSync})}else await l.navigate(d.action||g,{preventScrollReset:d.preventScrollReset,formData:v,body:p,formMethod:d.method||b,formEncType:d.encType||j,replace:d.replace,state:d.state,fromRouteId:c,flushSync:d.flushSync,viewTransition:d.viewTransition})},[l,s,c])}function Ky(l,{relative:s}={}){let{basename:c}=k.useContext(Ut),u=k.useContext(Qt);ke(u,"useFormAction must be used inside a RouteContext");let[d]=u.matches.slice(-1),g={...ki(l||".",{relative:s})},b=mn();if(l==null){g.search=b.search;let j=new URLSearchParams(g.search),v=j.getAll("index");if(v.some(E=>E==="")){j.delete("index"),v.filter(R=>R).forEach(R=>j.append("index",R));let E=j.toString();g.search=E?`?${E}`:""}}return(!l||l===".")&&d.route.index&&(g.search=g.search?g.search.replace(/^\?/,"?index&"):"?index"),c!=="/"&&(g.pathname=g.pathname==="/"?c:dn([c,g.pathname])),Ai(g)}function $y(l,{relative:s}={}){let c=k.useContext(Ug);ke(c!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:u}=Kg("useViewTransitionState"),d=ki(l,{relative:s});if(!c.isTransitioning)return!1;let g=hn(c.currentLocation.pathname,u)||c.currentLocation.pathname,b=hn(c.nextLocation.pathname,u)||c.nextLocation.pathname;return vo(d.pathname,b)!=null||vo(d.pathname,g)!=null}const Jy="/assets/logo-Hzr1jdtX.png",Wy=m.nav`
  background: #fff;
