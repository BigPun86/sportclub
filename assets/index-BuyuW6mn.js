 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kg;function Sy(){if(kg)return oe;kg=1;var a=Symbol.for("react.transitional.element"),s=Symbol.for("react.portal"),u=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),y=Symbol.for("react.context"),p=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),x=Symbol.for("react.lazy"),S=Symbol.iterator;function w(_){return _===null||typeof _!="object"?null:(_=S&&_[S]||_["@@iterator"],typeof _=="function"?_:null)}var T={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},A=Object.assign,B={};function H(_,K,F){this.props=_,this.context=K,this.refs=B,this.updater=F||T}H.prototype.isReactComponent={},H.prototype.setState=function(_,K){if(typeof _!="object"&&typeof _!="function"&&_!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,_,K,"setState")},H.prototype.forceUpdate=function(_){this.updater.enqueueForceUpdate(this,_,"forceUpdate")};function $(){}$.prototype=H.prototype;function X(_,K,F){this.props=_,this.context=K,this.refs=B,this.updater=F||T}var R=X.prototype=new $;R.constructor=X,A(R,H.prototype),R.isPureReactComponent=!0;var q=Array.isArray,G={H:null,A:null,T:null,S:null,V:null},W=Object.prototype.hasOwnProperty;function L(_,K,F,P,ee,he){return F=he.ref,{$$typeof:a,type:_,key:K,ref:F!==void 0?F:null,props:he}}function Q(_,K){return L(_.type,K,void 0,void 0,void 0,_.props)}function ae(_){return typeof _=="object"&&_!==null&&_.$$typeof===a}function Ne(_){var K={"=":"=0",":":"=2"};return"$"+_.replace(/[=:]/g,function(F){return K[F]})}var we=/\/+/g;function Ve(_,K){return typeof _=="object"&&_!==null&&_.key!=null?Ne(""+_.key):K.toString(36)}function Ut(){}function at(_){switch(_.status){case"fulfilled":return _.value;case"rejected":throw _.reason;default:switch(typeof _.status=="string"?_.then(Ut,Ut):(_.status="pending",_.then(function(K){_.status==="pending"&&(_.status="fulfilled",_.value=K)},function(K){_.status==="pending"&&(_.status="rejected",_.reason=K)})),_.status){case"fulfilled":return _.value;case"rejected":throw _.reason}}throw _}function ze(_,K,F,P,ee){var he=typeof _;(he==="undefined"||he==="boolean")&&(_=null);var re=!1;if(_===null)re=!0;else switch(he){case"bigint":case"string":case"number":re=!0;break;case"object":switch(_.$$typeof){case a:case s:re=!0;break;case x:return re=_._init,ze(re(_._payload),K,F,P,ee)}}if(re)return ee=ee(_),re=P===""?"."+Ve(_,0):P,q(ee)?(F="",re!=null&&(F=re.replace(we,"$&/")+"/"),ze(ee,K,F,"",function(st){return st})):ee!=null&&(ae(ee)&&(ee=Q(ee,F+(ee.key==null||_&&_.key===ee.key?"":(""+ee.key).replace(we,"$&/")+"/")+re)),K.push(ee)),1;re=0;var Fe=P===""?".":P+":";if(q(_))for(var ve=0;ve<_.length;ve++)P=_[ve],he=Fe+Ve(P,ve),re+=ze(P,K,F,he,ee);else if(ve=w(_),typeof ve=="function")for(_=ve.call(_),ve=0;!(P=_.next()).done;)P=P.value,he=Fe+Ve(P,ve++),re+=ze(P,K,F,he,ee);else if(he==="object"){if(typeof _.then=="function")return ze(at(_),K,F,P,ee);throw K=String(_),Error("Objects are not valid as a React child (found: "+(K==="[object Object]"?"object with keys {"+Object.keys(_).join(", ")+"}":K)+"). If you meant to render a collection of children, use an array instead.")}return re}function N(_,K,F){if(_==null)return _;var P=[],ee=0;return ze(_,P,"","",function(he){return K.call(F,he,ee++)}),P}function Z(_){if(_._status===-1){var K=_._result;K=K(),K.then(function(F){(_._status===0||_._status===-1)&&(_._status=1,_._result=F)},function(F){(_._status===0||_._status===-1)&&(_._status=2,_._result=F)}),_._status===-1&&(_._status=0,_._result=K)}if(_._status===1)return _._result.default;throw _._result}var ne=typeof reportError=="function"?reportError:function(_){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var K=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof _=="object"&&_!==null&&typeof _.message=="string"?String(_.message):String(_),error:_});if(!window.dispatchEvent(K))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",_);return}console.error(_)};function ce(){}return oe.Children={map:N,forEach:function(_,K,F){N(_,function(){K.apply(this,arguments)},F)},count:function(_){var K=0;return N(_,function(){K++}),K},toArray:function(_){return N(_,function(K){return K})||[]},only:function(_){if(!ae(_))throw Error("React.Children.only expected to receive a single React element child.");return _}},oe.Component=H,oe.Fragment=u,oe.Profiler=f,oe.PureComponent=X,oe.StrictMode=c,oe.Suspense=h,oe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=G,oe.__COMPILER_RUNTIME={__proto__:null,c:function(_){return G.H.useMemoCache(_)}},oe.cache=function(_){return function(){return _.apply(null,arguments)}},oe.cloneElement=function(_,K,F){if(_==null)throw Error("The argument must be a React element, but you passed "+_+".");var P=A({},_.props),ee=_.key,he=void 0;if(K!=null)for(re in K.ref!==void 0&&(he=void 0),K.key!==void 0&&(ee=""+K.key),K)!W.call(K,re)||re==="key"||re==="__self"||re==="__source"||re==="ref"&&K.ref===void 0||(P[re]=K[re]);var re=arguments.length-2;if(re===1)P.children=F;else if(1<re){for(var Fe=Array(re),ve=0;ve<re;ve++)Fe[ve]=arguments[ve+2];P.children=Fe}return L(_.type,ee,void 0,void 0,he,P)},oe.createContext=function(_){return _={$$typeof:y,_currentValue:_,_currentValue2:_,_threadCount:0,Provider:null,Consumer:null},_.Provider=_,_.Consumer={$$typeof:d,_context:_},_},oe.createElement=function(_,K,F){var P,ee={},he=null;if(K!=null)for(P in K.key!==void 0&&(he=""+K.key),K)W.call(K,P)&&P!=="key"&&P!=="__self"&&P!=="__source"&&(ee[P]=K[P]);var re=arguments.length-2;if(re===1)ee.children=F;else if(1<re){for(var Fe=Array(re),ve=0;ve<re;ve++)Fe[ve]=arguments[ve+2];ee.children=Fe}if(_&&_.defaultProps)for(P in re=_.defaultProps,re)ee[P]===void 0&&(ee[P]=re[P]);return L(_,he,void 0,void 0,null,ee)},oe.createRef=function(){return{current:null}},oe.forwardRef=function(_){return{$$typeof:p,render:_}},oe.isValidElement=ae,oe.lazy=function(_){return{$$typeof:x,_payload:{_status:-1,_result:_},_init:Z}},oe.memo=function(_,K){return{$$typeof:g,type:_,compare:K===void 0?null:K}},oe.startTransition=function(_){var K=G.T,F={};G.T=F;try{var P=_(),ee=G.S;ee!==null&&ee(F,P),typeof P=="object"&&P!==null&&typeof P.then=="function"&&P.then(ce,ne)}catch(he){ne(he)}finally{G.T=K}},oe.unstable_useCacheRefresh=function(){return G.H.useCacheRefresh()},oe.use=function(_){return G.H.use(_)},oe.useActionState=function(_,K,F){return G.H.useActionState(_,K,F)},oe.useCallback=function(_,K){return G.H.useCallback(_,K)},oe.useContext=function(_){return G.H.useContext(_)},oe.useDebugValue=function(){},oe.useDeferredValue=function(_,K){return G.H.useDeferredValue(_,K)},oe.useEffect=function(_,K,F){var P=G.H;if(typeof F=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return P.useEffect(_,K)},oe.useId=function(){return G.H.useId()},oe.useImperativeHandle=function(_,K,F){return G.H.useImperativeHandle(_,K,F)},oe.useInsertionEffect=function(_,K){return G.H.useInsertionEffect(_,K)},oe.useLayoutEffect=function(_,K){return G.H.useLayoutEffect(_,K)},oe.useMemo=function(_,K){return G.H.useMemo(_,K)},oe.useOptimistic=function(_,K){return G.H.useOptimistic(_,K)},oe.useReducer=function(_,K,F){return G.H.useReducer(_,K,F)},oe.useRef=function(_){return G.H.useRef(_)},oe.useState=function(_){return G.H.useState(_)},oe.useSyncExternalStore=function(_,K,F){return G.H.useSyncExternalStore(_,K,F)},oe.useTransition=function(){return G.H.useTransition()},oe.version="19.1.0",oe}var Dg;function xf(){return Dg||(Dg=1,bu.exports=Sy()),bu.exports}var C=xf();const je=xy(C);var xu={exports:{}},qr={},yu={exports:{}},vu={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Og;function jy(){return Og||(Og=1,function(a){function s(N,Z){var ne=N.length;N.push(Z);e:for(;0<ne;){var ce=ne-1>>>1,_=N[ce];if(0<f(_,Z))N[ce]=Z,N[ne]=_,ne=ce;else break e}}function u(N){return N.length===0?null:N[0]}function c(N){if(N.length===0)return null;var Z=N[0],ne=N.pop();if(ne!==Z){N[0]=ne;e:for(var ce=0,_=N.length,K=_>>>1;ce<K;){var F=2*(ce+1)-1,P=N[F],ee=F+1,he=N[ee];if(0>f(P,ne))ee<_&&0>f(he,P)?(N[ce]=he,N[ee]=ne,ce=ee):(N[ce]=P,N[F]=ne,ce=F);else if(ee<_&&0>f(he,ne))N[ce]=he,N[ee]=ne,ce=ee;else break e}}return Z}function f(N,Z){var ne=N.sortIndex-Z.sortIndex;return ne!==0?ne:N.id-Z.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;a.unstable_now=function(){return d.now()}}else{var y=Date,p=y.now();a.unstable_now=function(){return y.now()-p}}var h=[],g=[],x=1,S=null,w=3,T=!1,A=!1,B=!1,H=!1,$=typeof setTimeout=="function"?setTimeout:null,X=typeof clearTimeout=="function"?clearTimeout:null,R=typeof setImmediate<"u"?setImmediate:null;function q(N){for(var Z=u(g);Z!==null;){if(Z.callback===null)c(g);else if(Z.startTime<=N)c(g),Z.sortIndex=Z.expirationTime,s(h,Z);else break;Z=u(g)}}function G(N){if(B=!1,q(N),!A)if(u(h)!==null)A=!0,W||(W=!0,Ve());else{var Z=u(g);Z!==null&&ze(G,Z.startTime-N)}}var W=!1,L=-1,Q=5,ae=-1;function Ne(){return H?!0:!(a.unstable_now()-ae<Q)}function we(){if(H=!1,W){var N=a.unstable_now();ae=N;var Z=!0;try{e:{A=!1,B&&(B=!1,X(L),L=-1),T=!0;var ne=w;try{t:{for(q(N),S=u(h);S!==null&&!(S.expirationTime>N&&Ne());){var ce=S.callback;if(typeof ce=="function"){S.callback=null,w=S.priorityLevel;var _=ce(S.expirationTime<=N);if(N=a.unstable_now(),typeof _=="function"){S.callback=_,q(N),Z=!0;break t}S===u(h)&&c(h),q(N)}else c(h);S=u(h)}if(S!==null)Z=!0;else{var K=u(g);K!==null&&ze(G,K.startTime-N),Z=!1}}break e}finally{S=null,w=ne,T=!1}Z=void 0}}finally{Z?Ve():W=!1}}}var Ve;if(typeof R=="function")Ve=function(){R(we)};else if(typeof MessageChannel<"u"){var Ut=new MessageChannel,at=Ut.port2;Ut.port1.onmessage=we,Ve=function(){at.postMessage(null)}}else Ve=function(){$(we,0)};function ze(N,Z){L=$(function(){N(a.unstable_now())},Z)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(N){N.callback=null},a.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<N?Math.floor(1e3/N):5},a.unstable_getCurrentPriorityLevel=function(){return w},a.unstable_next=function(N){switch(w){case 1:case 2:case 3:var Z=3;break;default:Z=w}var ne=w;w=Z;try{return N()}finally{w=ne}},a.unstable_requestPaint=function(){H=!0},a.unstable_runWithPriority=function(N,Z){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var ne=w;w=N;try{return Z()}finally{w=ne}},a.unstable_scheduleCallback=function(N,Z,ne){var ce=a.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?ce+ne:ce):ne=ce,N){case 1:var _=-1;break;case 2:_=250;break;case 5:_=1073741823;break;case 4:_=1e4;break;default:_=5e3}return _=ne+_,N={id:x++,callback:Z,priorityLevel:N,startTime:ne,expirationTime:_,sortIndex:-1},ne>ce?(N.sortIndex=ne,s(g,N),u(h)===null&&N===u(g)&&(B?(X(L),L=-1):B=!0,ze(G,ne-ce))):(N.sortIndex=_,s(h,N),A||T||(A=!0,W||(W=!0,Ve()))),N},a.unstable_shouldYield=Ne,a.unstable_wrapCallback=function(N){var Z=w;return function(){var ne=w;w=Z;try{return N.apply(this,arguments)}finally{w=ne}}}}(vu)),vu}var Bg;function wy(){return Bg||(Bg=1,yu.exports=jy()),yu.exports}var Su={exports:{}},ut={};/**
 * @license React
...
`,tj=v.img`
  ...
  max-height: 50px;
  object-fit: contain;
`,nj={hauptsponsor:{name:"Fuchsbau Immobilien",logo:"/sponsors/fuchsbau-logo.png",website:"https://immofuchsbau.com/"},partners:[{name:"Graf Hardenberg",logo:"/sponsors/grafhardenberg.png",website:"https://www.grafhardenberg.de/"},{name:"Stadtwerke Konstanz",logo:"/sponsors/Stadtwerke.avif",website:"https://www.stadtwerke-konstanz.de/"},{name:"Sparkasse Bodensee",logo:"/sponsors/sparkasse-bodensee.png",website:"https://www.sparkasse-bodensee.de/"},{name:"MUMM Magazin",logo:"/sponsors/mumm-magazin.png",website:"https://www.nil-media.de/mumm-magazin/"},{name:"FUCHS",logo:"/sponsors/fuchs.png",website:"https://www.fuchs-haustechnik.de/"},{name:"Logan's Linde",logo:"/sponsors/logans-linde.png",website:"https://logans-wollmatingen.de/"},{name:"KARAKI Services",logo:"/sponsors/karaki-services.png",website:"https://karaki-services.de/"},{name:"Danlin Media",logo:"/sponsors/DANLIN.avif",website:"https://www.danlin-media.de/"},{name:"grenz|gänger tools",logo:"/sponsors/grenzgaenger-tools.png",website:"https://grenzgaenger-tools.de"}]};function aj(){const{hauptsponsor:a,partners:s}=nj;return r.jsxs(Z5,{children:[r.jsx(F5,{children:r.jsxs(P5,{href:a.website,target:"_blank",rel:"noopener noreferrer",children:[r.jsx(W5,{children:"Hauptsponsor"}),r.jsx(J5,{src:a.logo,alt:a.name})]})}),r.jsx(I5,{children:s.map((u,c)=>r.jsx(ej,{href:u.website,target:"_blank",rel:"noopener noreferrer",children:r.jsx(tj,{src:u.logo,alt:u.name})},c))})]})}const lj=v.div`
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));
  gap: 1.25rem;
 ...
 */var h6={L:Bl.QrCode.Ecc.LOW,M:Bl.QrCode.Ecc.MEDIUM,Q:Bl.QrCode.Ecc.QUARTILE,H:Bl.QrCode.Ecc.HIGH},Lb=128,Hb="L",Gb="#FFFFFF",Yb="#000000",$b=!1,Vb=1,m6=4,g6=0,p6=.1;function qb(a,s=0){const u=[];return a.forEach(function(c,f){let d=null;c.forEach(function(y,p){if(!y&&d!==null){u.push(`M${d+s} ${f+s}h${p-d}v1H${d+s}z`),d=null;return}if(p===c.length-1){if(!y)return;d===null?u.push(`M${p+s},${f+s} h1v1H${p+s}z`):u.push(`M${d+s},${f+s} h${p+1-d}v1H${d+s}z`);return}y&&d===null&&(d=p)})}),u.join("")}function Kb(a,s){return a.slice().map((u,c)=>c<s.y||c>=s.y+s.h?u:u.map((f,d)=>d<s.x||d>=s.x+s.w?f:!1))}function b6(a,s,u,c){if(c==null)return null;const f=a.length+u*2,d=Math.floor(s*p6),y=f/s,p=(c.width||d)*y,h=(c.height||d)*y,g=c.x==null?a.length/2-p/2:c.x*y,x=c.y==null?a.length/2-h/2:c.y*y,S=c.opacity==null?1:c.opacity;let w=null;if(c.excavate){let A=Math.floor(g),B=Math.floor(x),H=Math.ceil(p+g-A),$=Math.ceil(h+x-B);w={x:A,y:B,w:H,h:$}}const T=c.crossOrigin;return{x:g,y:x,h,w:p,excavation:w,opacity:S,crossOrigin:T}}function x6(a,s){return s!=null?Math.max(Math.floor(s),0):a?m6:g6}function Qb({value:a,level:s,minVersion:u,includeMargin:c,marginSize:f,imageSettings:d,size:y,boostLevel:p}){let h=je.useMemo(()=>{const A=(Array.isArray(a)?a:[a]).reduce((B,H)=>(B.push(...Bl.QrSegment.makeSegments(H)),B),[]);return Bl.QrCode.encodeSegments(A,h6[s],u,void 0,void 0,p)},[a,s,u,p]);const{cells:g,margin:x,numCells:S,calculatedImageSettings:w}=je.useMemo(()=>{let T=h.getModules();const A=x6(c,f),B=T.length+A*2,H=b6(T,y,A,d);return{cells:T,margin:A,numCells:B,calculatedImageSettings:H}},[h,y,d,c,f]);return{qrcode:h,margin:x,cells:g,numCells:S,calculatedImageSettings:w}}var y6=function(){try{new Path2D().addPath(new Path2D)}catch{return!1}return!0}(),v6=je.forwardRef(function(s,u){const c=s,{value:f,size:d=Lb,level:y=Hb,bgColor:p=Gb,fgColor:h=Yb,includeMargin:g=$b,minVersion:x=Vb,boostLevel:S,marginSize:w,imageSettings:T}=c,B=bf(c,["value","size","level","bgColor","fgColor","includeMargin","minVersion","boostLevel","marginSize","imageSettings"]),{style:H}=B,$=bf(B,["style"]),X=T?.src,R=je.useRef(null),q=je.useRef(null),G=je.useCallback(at=>{R.current=at,typeof u=="function"?u(at):u&&(u.current=at)},[u]),[W,L]=je.useState(!1),{margin:Q,cells:ae,numCells:Ne,calculatedImageSettings:we}=Qb({value:f,level:y,minVersion:x,boostLevel:S,includeMargin:g,marginSize:w,imageSettings:T,size:d});je.useEffect(()=>{if(R.current!=null){const at=R.current,ze=at.getContext("2d");if(!ze)return;let N=ae;const Z=q.current,ne=we!=null&&Z!==null&&Z.complete&&Z.naturalHeight!==0&&Z.naturalWidth!==0;ne&&we.excavation!=null&&(N=Kb(ae,we.excavation));const ce=window.devicePixelRatio||1;at.height=at.width=d*ce;const _=d/Ne*ce;ze.scale(_,_),ze.fillStyle=p,ze.fillRect(0,0,Ne,Ne),ze.fillStyle=h,y6?ze.fill(new Path2D(qb(N,Q))):ae.forEach(function(K,F){K.forEach(function(P,ee){P&&ze.fillRect(ee+Q,F+Q,1,1)})}),we&&(ze.globalAlpha=we.opacity),ne&&ze.drawImage(Z,we.x+Q,we.y+Q,we.w,we.h)}}),je.useEffect(()=>{L(!1)},[X]);const Ve=pf({height:d,width:d},H);let Ut=null;return X!=null&&(Ut=je.createElement("img",{src:X,key:X,style:{display:"none"},onLoad:()=>{L(!0)},ref:q,crossOrigin:we?.crossOrigin})),je.createElement(je.Fragment,null,je.createElement("canvas",pf({style:Ve,height:d,width:d,ref:G,role:"img"},$)),Ut)});v6.displayName="QRCodeCanvas";var Xb=je.forwardRef(function(s,u){const c=s,{value:f,size:d=Lb,level:y=Hb,bgColor:p=Gb,fgColor:h=Yb,includeMargin:g=$b,minVersion:x=Vb,boostLevel:S,title:w,marginSize:T,imageSettings:A}=c,B=bf(c,["value","size","level","bgColor","fgColor","includeMargin","minVersion","boostLevel","title","marginSize","imageSettings"]),{margin:H,cells:$,numCells:X,calculatedImageSettings:R}=Qb({value:f,level:y,minVersion:x,boostLevel:S,includeMargin:g,marginSize:T,imageSettings:A,size:d});let q=$,G=null;A!=null&&R!=null&&(R.excavation!=null&&(q=Kb($,R.excavation)),G=je.createElement("image",{href:A.src,height:R.h,width:R.w,x:R.x+H,y:R.y+H,preserveAspectRatio:"none",opacity:R.opacity,crossOrigin:R.crossOrigin}));const W=qb(q,H);return je.createElement("svg",pf({height:d,width:d,viewBox:`0 0 ${X} ${X}`,ref:u,role:"img"},B),!!w&&je.createElement("title",null,w),je.createElement("path",{fill:p,d:`M0,0 h${X}v${X}H0z`,shapeRendering:"crispEdges"}),je.createElement("path",{fill:h,d:W,shapeRendering:"crispEdges"}),G)});Xb.displayName="QRCodeSVG";const S6={subtitle:"Nach der Meisterschaft in der Landesliga spielt unsere erste Mannschaft ab der Saison 2026/27 in der Verbandsliga. 100 Felder, 500 € pro Feld und Saison - jedes Feld steht für einen Förderer.",heroImage:"/sckw-logo-500club.png",heroTitle:"500er Club",sectionTitle:"Unterstützungsmöglichkeiten",memberships:[{value:500,label:"500 €",duration:"1 Jahr",description:"Saison 2026/27"},{value:1e3,label:"1.000 €",duration:"2 Jahre",description:"Unterstützung"},{value:1500,label:"1.500 €",duration:"3 Jahre",description:"Unterstützung"}],customAmount:{label:"Eigener Betrag",minAmount:500,minHint:"Mindestens 500 €"},benefits:[{icon:"📄",title:"Spendenbescheinigung",text:"Der SC Konstanz-Wollmatingen ist als gemeinnützig anerkannt. Auf Wunsch erhalten Sie eine Zuwendungsbestätigung."},{icon:"🏅",title:"Ihr Name auf der Tafel",text:'Wenn Sie möchten. Wer lieber im Hintergrund bleibt, erscheint als „SCKW Gönner".'},{icon:"⚽",title:"Direkte Förderung der Ersten",text:"Auswärtsfahrten, Training, Material und Spielbetrieb in der Verbandsliga."}],spendentafel:{label:"Spendentafel (optional)",sublabel:"Tragen Sie hier Ihren Namen oder Firmennamen ein, wenn Sie auf unserer Spendentafel (Website & Vereinsgelände) veröffentlicht werden möchten. Lassen Sie das Feld leer, wenn Sie anonym spenden möchten.",nameFieldPlaceholder:"Name/Firma für die Spendentafel (leer = anonym)"},bescheinigung:{label:"Ich möchte eine Spendenbescheinigung erhalten",hinweis:"Sie erhalten Ihre Spendenbescheinigung per E-Mail als PDF.",fields:{vorname:"Vorname",nachname:"Nachname",email:"E-Mail",strasse:"Straße + Hausnr.",plz:"PLZ",ort:"Ort"}},bankCtaLabel:"Per Überweisung spenden",ueberweisungHinweis:"Ihr Name und Ihre Adresse werden automatisch in den Verwendungszweck übernommen, damit wir Ihnen die Spendenbescheinigung zuschicken können.",verwendungszweck:"CLUB 500",bankDetails:{kontoinhaber:"Sport Club Konstanz-Wollmatingen e.V.",iban:"DE84 6905 0001 0000 0929 99",ibanClean:"DE84690500010000092999",bic:"SOLADES1KNZ",bank:"Sparkasse Bodensee",adresse:"Schleyerweg 5 · 78467 Konstanz"}},j6=100,w6=[{feld:1,name:"Ulrike Dunand",anonym:!1,saisonBis:2027},{feld:2,name:"Dieter Graf",anonym:!1,saisonBis:2027},{feld:3,name:"Bernd Reister",anonym:!1,saisonBis:2027},{feld:4,name:"Stefan Weber",anonym:!1,saisonBis:2027},{feld:5,name:"Lutz Grüneberg",anonym:!1,saisonBis:2027},{feld:6,name:"Steffen Allert",anonym:!1,saisonBis:2028},{feld:7,name:"Fa. Müller Putz & Stuck GmbH",anonym:!1,saisonBis:2027},{feld:8,name:"René Frey",anonym:!1,saisonBis:2027},{feld:9,name:"Luciano Rossetti",anonym:!1,saisonBis:2027},{feld:10,name:"Paolo Rossetti",anonym:!1,saisonBis:2027},{feld:11,name:"Rolf Degen",anonym:!1,saisonBis:2027},{feld:12,name:"Senioren des SCKW",anonym:!1,saisonBis:2027},{feld:13,name:"Brigitte und Thomas Fuchs",anonym:!1,saisonBis:2027},{feld:14,name:"ZMVZ|Dr. Schütz GmbH",anonym:!1,saisonBis:2027},{feld:17,name:"Manni",anonym:!1,saisonBis:2027}],_6={felderGesamt:j6,foerderer:w6},z0="SCKW Gönner",Oa={blau:"#0061D6",magenta:"#CC0546",navy:"#021A3E",grund:"#010814",rahmen:"#264270",weiss:"#FFFFFF",gedaempft:"#96BAF0"};function E6(){const{felderGesamt:a,foerderer:s}=_6,u=new Map(s.map(d=>[d.feld,d])),c=s.length,f=Array.from({length:a},(d,y)=>y+1);return r.jsx("section",{"aria-labelledby":"tafel-titel",style:{background:Oa.grund,padding:"3rem 1rem",color:Oa.weiss},children:r.jsxs("div",{style:{maxWidth:1100,margin:"0 auto"},children:[r.jsx("h2",{id:"tafel-titel",style:{textAlign:"center",fontSize:"clamp(1.5rem,4vw,2.25rem)",margin:0},children:"Unsere Förderer"}),r.jsxs("p",{style:{textAlign:"center",fontWeight:700,letterSpacing:".05em",marginTop:".75rem"},children:[c," von ",a," Feldern vergeben"]}),r.jsx("div",{role:"progressbar","aria-valuenow":c,"aria-valuemin":0,"aria-valuemax":a,"aria-label":`${c} von ${a} Feldern vergeben`,style:{height:10,borderRadius:999,background:"#0E1E3A",overflow:"hidden",margin:"0 auto 2rem",maxWidth:640},children:r.jsx("div",{style:{width:`${c/a*100}%`,height:"100%",background:Oa.magenta}})}),r.jsx("ol",{style:{listStyle:"none",display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(140px, 1fr))",gap:".5rem",padding:0,margin:0},children:f.map(d=>{const y=u.get(d),p=y?y.anonym?z0:y.name:null,h=p?p.replace("|",`
`):null;return r.jsxs("li",{style:{background:y?Oa.blau:Oa.navy,border:y?"none":`2px solid ${Oa.rahmen}`,borderRadius:8,padding:".5rem .4rem",minHeight:62,display:"flex",flexDirection:"column",justifyContent:y?"space-between":"center",alignItems:y?"stretch":"center"},children:[r.jsx("span",{style:{fontSize:y?".7rem":"1.1rem",fontWeight:700,color:y?"#C6DEFC":"#5C7CA0",lineHeight:1},children:String(d).padStart(2,"0")}),h&&r.jsx("span",{style:{fontSize:".8rem",fontWeight:600,textAlign:"center",lineHeight:1.15,hyphens:"auto",whiteSpace:"pre-line"},children:h})]},d)})}),r.jsxs("p",{style:{textAlign:"center",marginTop:"2rem",color:Oa.gedaempft,fontSize:".95rem"},children:["Jedes Feld steht für einen Förderer unserer ersten Mannschaft. Ob Ihr Name erscheint, entscheiden Sie selbst - sonst steht dort „",z0,'".']})]})})}const z6=v.section`
  background: #0b0b0d;
  min-height: 70vh;
  display: flex;
  align-items: center;
...
`,l_=v.div`
  ...
  display: flex;
  justify-content: center;
`;function r_(){return r.jsxs(r.Fragment,{children:[r.jsx(a_,{}),r.jsx(l_,{children:r.jsx(q4,{})})]})}function i_(){const{pathname:a,hash:s}=on();return C.useEffect(()=>{if(!s){window.scrollTo(0,0);return}const u=decodeURIComponent(s.slice(1));let c=0,f=0,d=0;const y=()=>{const p=document.getElementById(u);p?(p.scrollIntoView({block:"start"}),d=window.setTimeout(()=>p.scrollIntoView({block:"start"}),400)):c++<20&&(f=window.setTimeout(y,100))};return y(),()=>{window.clearTimeout(f),window.clearTimeout(d)}},[a,s]),null}function s_(){return r.jsxs($2,{children:[r.jsx(i_,{}),r.jsxs(x2,{children:[r.jsx(ln,{path:"/",element:r.jsxs(r.Fragment,{children:[r.jsx(Cl,{}),r.jsx(ks,{to:"/sponsoring",replace:!0})]})}),r.jsx(ln,{path:"/sponsoring",element:r.jsxs(r.Fragment,{children:[r.jsx(Cl,{}),r.jsx(xw,{})]})}),r.jsx(ln,{path:"/sponsoring-handoff",element:r.jsx(Xw,{})}),r.jsx(ln,{path:"/widget",element:r.jsx(r_,{})}),r.jsx(ln,{path:"/sponsoring/club-500",element:r.jsxs(r.Fragment,{children:[r.jsx(Cl,{}),r.jsx(y4,{})]})}),r.jsx(ln,{path:"/sponsoring/pakete",element:r.jsx(ks,{to:"/sponsoring#angebot",replace:!0})}),r.jsx(ln,{path:"/sponsoring/spielerpatenschaft",element:r.jsxs(r.Fragment,{children:[r.jsx(Cl,{}),r.jsx(S4,{})]})}),r.jsx(ln,{path:"/mockup-generator",element:r.jsxs(r.Fragment,{children:[r.jsx(Cl,{}),r.jsx(f6,{})]})}),r.jsx(ln,{path:"/renovierung",element:r.jsxs(r.Fragment,{children:[r.jsx(Cl,{}),r.jsx($5,{})]})}),r.jsx(ln,{path:"*",element:r.jsx(ks,{to:"/sponsoring",replace:!0})})]})]})}console.log("sckw sponsoring Website loaded");Ay.createRoot(document.getElementById("root")).render(r.jsx(C.StrictMode,{children:r.jsx(zv,{theme:ai,children:r.jsx(s_,{})})}));
