...
`,lj=v.div`
  ...
  font-weight: 600;
  line-height: 1.3;
`,rj={hauptsponsor:{name:"Fuchsbau Immobilien",logo:"/sponsors/fuchsbau-logo.png",website:"https://immofuchsbau.com/"},partners:[{name:"Tasty Delivery",logo:"/sponsors/tasty.png",website:"https://tasty-delivery.de"},{name:"Stadtwerke Konstanz",logo:"/sponsors/Stadtwerke.avif",website:"https://www.stadtwerke-konstanz.de/"},{name:"Graf Hardenberg",logo:"/sponsors/grafhardenberg.png",website:"https://www.grafhardenberg.de/"},{name:"Kountz",logo:"/sponsors/KOUNTZ.avif",website:"#"},{name:"Rothaus",logo:"/sponsors/Rothaus.avif",website:"https://www.rothaus.de/"},{name:"J&C",logo:"/sponsors/JC.avif",website:"#"},{name:"Danlin Media",logo:"/sponsors/DANLIN.avif",website:"#"},{name:"Logan's Linde",logo:"/sponsors/logans.png",website:"https://logans-wollmatingen.de/"}]};function ij(){const{hauptsponsor:a,partners:s}=rj;return r.jsxs(P5,{children:[r.jsx(F5,{children:r.jsxs(W5,{href:a.website,target:"_blank",rel:"noopener noreferrer",children:[r.jsx(J5,{children:"Hauptsponsor"}),r.jsx(I5,{src:a.logo,alt:a.name}),r.jsx(ej,{children:a.name})]})}),r.jsx(tj,{children:s.map((u,c)=>r.jsxs(nj,{href:u.website,target:"_blank",rel:"noopener noreferrer",children:[r.jsx(aj,{src:u.logo,alt:u.name}),r.jsx(lj,{children:u.name})]},c))})]})}const sj=v.div`
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));
  gap: 1.25rem;
