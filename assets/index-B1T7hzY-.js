...
`;function Es(){const i=xn(),[o,u]=M.useState(!1);return l.jsx(PS,{children:l.jsxs(IS,{children:[l.jsx(Nu,{to:"/",onClick:()=>u(!1),children:l.jsxs(e5,{children:[l.jsx(t5,{src:FS,alt:"SCKW Logo"}),l.jsx(n5,{children:"SC Konstanz-Wollmatingen e. V."})]})}),l.jsxs(i5,{"aria-label":"Menü öffnen/schließen","aria-expanded":o,"aria-controls":"mobile-nav",onClick:()=>u(f=>!f),children:["Menü",l.jsx("span",{style:{fontSize:"1.25rem",marginLeft:"0.1rem"},children:"☰"})]}),l.jsxs(a5,{id:"mobile-nav",$open:o,children:[l.jsx(Nu,{to:"/sponsoring",$active:i.pathname==="/sponsoring"||i.pathname==="/sponsoring-v2",onClick:()=>u(!1),children:"🤝 Sponsoring"}),l.jsx(Nu,{to:"/jobs",$active:i.pathname==="/jobs",onClick:()=>u(!1),children:"💼 Jobbörse"}),!1]})]})})}const l5=h.footer`
  width: 100%;
  text-align: center;
  padding: 2rem 1rem;
  font-size: 0.95rem;
...
Herzliche Grüße
`);return`mailto:${E5}?subject=${y}&body=${x}`},f=p=>{const j=p.maxSponsors-(p.sponsors?.length||0);return{availableSlots:j,isFullyBooked:j===0}},m=i.filter(p=>!p.title.includes("Platz-Renovierung"));return l.jsx(c5,{children:m.map((p,j)=>{const{isFullyBooked:y}=f(p),x=o(p.status),T=x==="vergeben"||y,w=y?"vergeben":x,N=p.keyBenefits||[];return l.jsxs(u5,{isVergeben:T,children:[l.jsxs(d5,{children:[l.jsx(f5,{children:u(p.title)}),l.jsx(h5,{children:p.title.replace(new RegExp("^(\\p{Emoji_Presentation}|\\p{Extended_Pictographic}|[\\u2600-\\u27BF])\\s*","u"),"").trim()}),!T&&l.jsx(m5,{children:p.price}),l.jsx(g5,{status:w,children:w==="vergeben"?"✅ Vergeben":"🟩 Verfügbar"})]}),T&&p.sponsors&&p.sponsors.length>0?l.jsxs(S5,{children:[p.sponsors[0].image&&l.jsx(j5,{src:`/sponsors/${p.sponsors[0].image}`,alt:p.sponsors[0].name}),l.jsx(w5,{children:p.sponsors[0].name}),l.jsxs(z5,{children:["Hauptsponsor seit ",p.sponsors[0].since]}),p.sponsors[0].website&&l.jsx(_5,{href:p.sponsors[0].website,target:"_blank",rel:"noopener noreferrer",children:"🔗 Website besuchen"})]}):l.jsx(p5,{children:N.map((G,V)=>l.jsxs(x5,{isHighlight:G.highlight,children:[l.jsx(b5,{children:G.icon}),l.jsx(y5,{children:G.text})]},V))}),l.jsx(v5,{href:T?void 0:c(p.title),isVergeben:T,children:T?"Vergeben":"Jetzt anfragen"})]},j)})})}const T5=h.div`
  margin: 2rem 0;
  border-radius: 12px;
...
`;function Uu({icon:i,title:o,description:u,packages:c,buttonHref:f,buttonText:m}){return l.jsxs(oj,{children:[l.jsx(cj,{children:i}),l.jsx(uj,{children:o}),l.jsx(dj,{children:u}),l.jsx(fj,{children:c.map((p,j)=>l.jsxs("div",{children:[p,j<c.length-1&&l.jsx("br",{})]},j))}),l.jsx(hj,{href:f,children:m})]})}const mj=h.div`
  display: grid;
...
`));return}alert("Danke! Wir melden uns innerhalb von 24 Stunden."),m.reset()};return l.jsx(bj,{id:"kontakt",children:l.jsxs(yj,{children:[l.jsx(Mj,{children:i}),l.jsx(kj,{children:o}),l.jsx(mj,{children:u.map((f,m)=>l.jsxs(gj,{children:[l.jsxs(pj,{children:[f.icon," ",f.title]}),l.jsx(xj,{$isEmail:f.isEmail,children:f.isEmail?l.jsx("a",{href:`mailto:${f.content}`,children:f.content}):f.content})]},m))}),l.jsxs(vj,{children:[l.jsx(Sj,{children:"Kontakt aufnehmen"}),l.jsx(jj,{children:"Kurzformular ausfüllen - wir melden uns innerhalb von 24 Stunden."}),l.jsxs(wj,{noValidate:!0,onSubmit:c,children:[l.jsxs(Lu,{children:[l.jsxs(Il,{children:[l.jsx("label",{htmlFor:"firstName",children:"Vorname"}),l.jsx("input",{id:"firstName",name:"firstName",type:"text",autoComplete:"given-name",required:!0})]}),l.jsxs(Il,{children:[l.jsx("label",{htmlFor:"lastName",children:"Nachname"}),l.jsx("input",{id:"lastName",name:"lastName",type:"text",autoComplete:"family-name",required:!0})]})]}),l.jsxs(Lu,{children:[l.jsxs(Il,{children:[l.jsx("label",{htmlFor:"company",children:"Firma (optional)"}),l.jsx("input",{id:"company",name:"company",type:"text",autoComplete:"organization"})]}),l.jsxs(Il,{children:[l.jsx("label",{htmlFor:"phone",children:"Telefon"}),l.jsx("input",{id:"phone",name:"phone",type:"tel",autoComplete:"tel",required:!0})]})]}),l.jsx(Lu,{children:l.jsxs(zj,{children:[l.jsx("label",{htmlFor:"email",children:"E-Mail"}),l.jsx("input",{id:"email",name:"email",type:"email",autoComplete:"email",required:!0})]})}),l.jsxs(_j,{"aria-hidden":"true",tabIndex:-1,children:[l.jsx("label",{htmlFor:"website",children:"Wenn Sie ein Mensch sind, lassen Sie dieses Feld leer"}),l.jsx("input",{id:"website",name:"website",type:"text",autoComplete:"off"})]}),l.jsxs(Ej,{children:[l.jsx("input",{id:"consent",name:"consent",type:"checkbox",required:!0}),l.jsxs("label",{htmlFor:"consent",children:["Ich stimme der Verarbeitung meiner Daten gemäß"," ",l.jsx("a",{href:"/datenschutz",target:"_blank",rel:"noopener noreferrer",children:"Datenschutzhinweisen"})," ","zu."]})]}),l.jsxs(Tj,{children:[l.jsx(Aj,{type:"submit",children:"Absenden"}),l.jsxs(Cj,{children:["Alternativ:"," ",l.jsx("a",{href:"mailto:sponsoring@sckw.de",children:"sponsoring@sckw.de"})]})]})]})]})]})})}const bj=h.section`
  background: #f7f7fa;
  border-radius: 10px;
  padding: 2.5rem 2rem;
...
`,M0=h.a`
  ...
  box-sizing: border-box;
  pointer-events: ${i=>i.isVergeben?"none":"auto"};
`,V2="sponsoring@sckw.de";function q2({packages:i}){const o=c=>{const f=c.replace(/[^\w\s]/gi,"").trim(),m=encodeURIComponent(`Interesse am Paket "${f}"`);return`mailto:${V2}?subject=${m}`},u=c=>{const f=c.benefits.find(p=>{const j=p.toLowerCase();return j.includes("social media")||j.includes("instagram")});if(!f)return"-";const m=f.toLowerCase();return m.includes("premium")||m.includes("allen")?"ÜBERALL":m.includes("sehr präsent")?"Sehr präsent":m.includes("regelmässig")||m.includes("regelmäßig")?"Regelmäßig":"Standard"};return l.jsxs(D2,{children:[l.jsx(O2,{children:l.jsxs(N2,{children:[l.jsx("thead",{children:l.jsxs("tr",{children:[l.jsx(C0,{children:"Paket"}),i.map((c,f)=>l.jsx(C0,{isVergeben:c.status.includes("Vergeben"),children:c.title},f))]})}),l.jsxs("tbody",{children:[l.jsxs("tr",{children:[l.jsx(La,{children:"Preis"}),i.map((c,f)=>l.jsx(H2,{isVergeben:c.status.includes("Vergeben"),children:c.price},f))]}),l.jsxs("tr",{children:[l.jsx(La,{children:"Trikot/Banner"}),i.map((c,f)=>{const m=c.benefits.find(p=>p.includes("Trikot")||p.includes("Banner"));return l.jsx(La,{children:m?"✅ Ja":"-"},f)})]}),l.jsxs("tr",{children:[l.jsx(La,{children:"Social Media"}),i.map((c,f)=>{const m=u(c);return l.jsx(La,{isHighlight:m==="ÜBERALL",children:m==="-"?"-":`✅ ${m}`},f)})]}),l.jsxs("tr",{children:[l.jsx(La,{children:"Aktion"}),i.map((c,f)=>l.jsx(La,{children:l.jsx(M0,{href:c.status.includes("Vergeben")?void 0:o(c.title),isVergeben:c.status.includes("Vergeben"),children:c.status.includes("Vergeben")?"Vergeben":"Anfragen"})},f))]})]})]})}),l.jsx(U2,{children:i.map((c,f)=>{const m=c.status.includes("Vergeben");return l.jsxs(L2,{isVergeben:m,children:[l.jsx(G2,{children:c.title}),l.jsx(Y2,{children:c.price}),l.jsxs($u,{children:[l.jsx("span",{children:"Status"}),l.jsx("span",{children:m?"🟥 Vergeben":"🟩 Verfügbar"})]}),l.jsxs($u,{children:[l.jsx("span",{children:"Social Media"}),l.jsx("span",{children:u(c)})]}),l.jsxs($u,{children:[l.jsx("span",{children:"Vorteile"}),l.jsxs("span",{children:[c.benefits.length," Leistungen"]})]}),l.jsx(M0,{href:m?void 0:o(c.title),isVergeben:m,children:m?"Bereits vergeben":"Jetzt anfragen"})]},f)})})]})}const K2=h.div`
  margin-top: 2.5rem;
`,Z2=h.div`
  display: flex;
  gap: 0.5rem;
...
`,od=h.div`margin-bottom: 4mm;`,Hs=h.label`
  display: block;
  font-size: 9pt;
  font-weight: 700;
  color: #1a365d;
...
`;h.p`
  ...
  margin: 1.5rem 0 0 0;
  text-align: center;
`;Ax();const pz=!1;function xz(){return l.jsx(GS,{children:l.jsxs(gS,{children:[l.jsx(Ga,{path:"/",element:l.jsxs(l.Fragment,{children:[l.jsx(Es,{}),l.jsx(_d,{to:"/sponsoring",replace:!0})]})}),l.jsx(Ga,{path:"/sponsoring",element:l.jsxs(l.Fragment,{children:[l.jsx(Es,{}),l.jsx(lw,{})]})}),l.jsx(Ga,{path:"/sponsoring-v2",element:l.jsx(_d,{to:"/sponsoring",replace:!0})}),l.jsx(Ga,{path:"/sponsoring-v1",element:l.jsxs(l.Fragment,{children:[l.jsx(Es,{}),l.jsx(g2,{})]})}),l.jsx(Ga,{path:"/sponsoring-handoff",element:l.jsx(Rw,{})}),l.jsx(Ga,{path:"/jobs",element:l.jsxs(l.Fragment,{children:[l.jsx(Es,{}),l.jsx(gz,{})]})}),pz]})})}const bz={colors:{primary:"#d9245f",primaryDark:"#b81d51",primaryLight:"#ff4b82",secondary:"#1696ff",secondaryDark:"#0e6ec0",secondaryLight:"#5ab8ff",text:"#222",textMuted:"#666",bg:"#fff",bgMuted:"#f8f9fa",border:"#e9ecef"}};console.log("sckw sponsoring Website loaded");gy.createRoot(document.getElementById("root")).render(l.jsx(M.StrictMode,{children:l.jsx(gv,{theme:bz,children:l.jsx(xz,{})})}));
