...
`;function zl(){const a=on(),[s,u]=C.useState(!1);return r.jsx(I2,{children:r.jsxs(e5,{children:[r.jsx(Cu,{to:"/",onClick:()=>u(!1),children:r.jsxs(t5,{children:[r.jsx(n5,{src:W2,alt:"SCKW Logo"}),r.jsx(a5,{children:"SC Konstanz-Wollmatingen e. V."})]})}),r.jsxs(r5,{"aria-label":"Menü öffnen/schließen","aria-expanded":s,"aria-controls":"mobile-nav",onClick:()=>u(f=>!f),children:["Menü",r.jsx("span",{style:{fontSize:"1.25rem",marginLeft:"0.1rem"},children:"☰"})]}),r.jsxs(l5,{id:"mobile-nav",$open:s,children:[r.jsx(Cu,{to:"/sponsoring",$active:a.pathname==="/sponsoring",onClick:()=>u(!1),children:"🤝 Sponsoring"}),r.jsx(Cu,{to:"/sponsoring/club-500",$active:a.pathname==="/sponsoring/club-500",onClick:()=>u(!1),children:"⚽ CLUB 500"}),!1]})]})})}const i5=y.footer`
  width: 100%;
  text-align: center;
  padding: 2rem 1rem;
  font-size: 0.95rem;
...
`,J5=()=>{const a=R5;return{kabinen:{current:a.packages.kabinen.current,goal:a.packages.kabinen.goal,donors:a.packages.kabinen.donors},fassade:{current:a.packages.fassade.current,goal:a.packages.fassade.goal,donors:a.packages.fassade.donors},waschkueche:{current:a.packages.waschkueche.current,goal:a.packages.waschkueche.goal,donors:a.packages.waschkueche.donors}}};function W5({data:a=J5(),realTime:s=!1}){const[u,c]=C.useState(a),[f,d]=C.useState(new Date),[v,p]=C.useState(!1),h=async()=>{p(!0);try{const S=await fetch("https://raw.githubusercontent.com/BigPun86/sportclub/main/src/data/donationData.json",{cache:"no-cache",headers:{"Cache-Control":"no-cache, no-store, must-revalidate",Pragma:"no-cache"}});if(S.ok){const w=await S.json(),R={kabinen:{current:w.packages.kabinen.current,goal:w.packages.kabinen.goal,donors:w.packages.kabinen.donors},fassade:{current:w.packages.fassade.current,goal:w.packages.fassade.goal,donors:w.packages.fassade.donors},waschkueche:{current:w.packages.waschkueche.current,goal:w.packages.waschkueche.goal,donors:w.packages.waschkueche.donors}};c(R),d(new Date),console.log("✅ Spendendaten aktualisiert!")}}catch(S){console.error("❌ Fehler beim Laden der Spendendaten:",S)}finally{p(!1)}};C.useEffect(()=>{if(!s)return;const S=setInterval(()=>{h()},3e4);return()=>clearInterval(S)},[s]);const g=S=>{switch(S){case"kabinen":return"🔧";case"fassade":return"🎨";case"waschkueche":return"🧺";default:return"💰"}},x=S=>{switch(S){case"kabinen":return"Kabinen sanieren";case"fassade":return"Fassade & Fenster";case"waschkueche":return"Waschküche modernisieren";default:return S}};return r.jsxs(r.Fragment,{children:[r.jsx(M5,{children:Object.entries(u).map(([S,w])=>{const R=w.current/w.goal*100;return r.jsxs(k5,{children:[r.jsxs(D5,{children:[g(S)," ",x(S)]}),r.jsxs(O5,{children:[r.jsxs(B5,{children:[r.jsxs("span",{children:[w.current.toLocaleString("de-DE")," €"]}),r.jsxs("span",{children:[w.goal.toLocaleString("de-DE")," €"]})]}),r.jsx(N5,{children:r.jsx(U5,{$progress:R})}),r.jsxs(L5,{children:[Math.round(R),"% erreicht"]})]}),r.jsxs(H5,{children:[r.jsxs(G5,{children:["💝 Spender (",w.donors.length,")"]}),r.jsx(Y5,{children:w.donors.length>0?w.donors.slice().reverse().map((A,B)=>r.jsxs($5,{children:[r.jsxs(V5,{children:[r.jsx(q5,{children:A.anonymous?"Anonymer Spender":A.name}),A.comment&&r.jsxs(Q5,{children:['"',A.comment,'"']}),A.date&&r.jsx(X5,{children:A.date})]}),r.jsxs(K5,{children:[A.amount.toLocaleString("de-DE")," €"]})]},B)):r.jsx(Z5,{children:"Noch keine Spenden 🤗"})})]})]},S)})}),r.jsxs(P5,{onClick:h,disabled:v,title:"Spendendaten aktualisieren",children:["🔄",v?"Lade...":"Aktualisieren"]}),r.jsxs(F5,{children:["Letztes Update: ",f.toLocaleTimeString("de-DE")]})]})}const I5=y.section`
  background: url("${A5("herren",18)}") center/cover;
  min-height: 400px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,HS=y.p`
  ...
  margin: 1.5rem 0 0 0;
  text-align: center;
`,Cl=w1();function Yu({images:a,onImageClick:s}){const[u,c]=C.useState(0);return C.useEffect(()=>{if(a.length<=1)return;const f=setInterval(()=>{c(d=>(d+1)%a.length)},4e3);return()=>clearInterval(f)},[a.length]),a.length===0?r.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%",color:"#64748b",fontSize:"0.9rem",textAlign:"center"},children:"📷 Bilder folgen bald"}):r.jsxs(hS,{children:[a.map((f,d)=>r.jsx(mS,{src:f.src,alt:f.alt,$isActive:d===u,onClick:()=>s(d)},d)),a.length>1&&r.jsx(gS,{children:a.map((f,d)=>r.jsx(pS,{$isActive:d===u,onClick:()=>c(d)},d))})]})}function GS({images:a,initialIndex:s,onClose:u}){const[c,f]=C.useState(s),d=C.useCallback(()=>{f(p=>(p+1)%a.length)},[a.length]),v=C.useCallback(()=>{f(p=>(p-1+a.length)%a.length)},[a.length]);return C.useEffect(()=>{const p=h=>{h.key==="Escape"&&u(),h.key==="ArrowRight"&&d(),h.key==="ArrowLeft"&&v()};return document.addEventListener("keydown",p),()=>document.removeEventListener("keydown",p)},[u,d,v]),r.jsx(bS,{onClick:u,children:r.jsxs(xS,{onClick:p=>p.stopPropagation(),children:[r.jsx(vS,{onClick:u,children:"×"}),r.jsx(yS,{src:a[c].src,alt:a[c].alt}),a.length>1&&r.jsxs(r.Fragment,{children:[r.jsx(l0,{$direction:"prev",onClick:v,children:"‹"}),r.jsx(l0,{$direction:"next",onClick:d,children:"›"})]})]})})}function YS(){const[a,s]=C.useState(!1),[u,c]=C.useState([]),[f,d]=C.useState(0),[v,p]=C.useState(!1),h=(S,w)=>{c(S),d(w),s(!0)},g=S=>{S.preventDefault(),p(!0)},x=()=>{navigator.clipboard.writeText("DE12 6905 0001 0000 0228 06")};return r.jsxs(r.Fragment,{children:[r.jsx(I5,{children:r.jsxs(eS,{children:[r.jsx(tS,{children:"🏟️ Fürstenberg weiterentwickeln"}),r.jsx(nS,{children:"Unser Kultplatz verdient es - gemeinsam machen wir den Charme noch besser"})]})}),r.jsxs(aS,{children:[r.jsxs(lS,{children:[r.jsx(rS,{children:"Der Fürstenberg - unser Kultplatz"}),r.jsx(iS,{children:"Der Fürstenberg ist mehr als ein Sportplatz - er ist das Herzstück unseres Vereins mit einer einzigartigen Atmosphäre und besonderem Charme. Dieser authentische Charakter macht ihn zu dem, was er ist: unser Zuhause."}),r.jsxs(sS,{children:[r.jsx(oS,{children:"✨ Charme erhalten, Komfort verbessern"}),r.jsx(cS,{children:"Wir möchten den besonderen Charakter des Fürstenberg bewahren und gleichzeitig einige Bereiche behutsam weiterentwickeln. Mit Ihrer Unterstützung können wir das Beste aus beiden Welten schaffen."})]})]}),r.jsxs(uS,{children:[r.jsx(fS,{children:"🔍 Wo wir ansetzen möchten"}),r.jsxs(dS,{children:[r.jsxs(Tu,{children:[r.jsx(Ru,{children:r.jsx(Yu,{images:Cl.kabinen,onImageClick:S=>h(Cl.kabinen,S)})}),r.jsx(Mu,{children:"🔧 Kabinen komfortabler gestalten"}),r.jsx(ku,{children:"Die Kabinen haben schon viele Geschichten erlebt - nun möchten wir ihnen mit neuen Bänken, frischen Wänden und durchdachter Ausstattung mehr Komfort verleihen, ohne ihren authentischen Charakter zu verlieren."})]}),r.jsxs(Tu,{children:[r.jsx(Ru,{children:r.jsx(Yu,{images:Cl.fassade,onImageClick:S=>h(Cl.fassade,S)})}),r.jsx(Mu,{children:"🎨 Fassade & Fenster erneuern"}),r.jsx(ku,{children:"Die Außenfassade hat ihren Dienst getan und möchte nun erneuert werden. Neue Fenster, frischer Putz und eine ansprechende Gestaltung werden dem Fürstenberg gut stehen - und bieten Raum für die Namen unserer Partner, die diesen Kultplatz unterstützen."})]}),r.jsxs(Tu,{children:[r.jsx(Ru,{children:r.jsx(Yu,{images:Cl.waschkueche,onImageClick:S=>h(Cl.waschkueche,S)})}),r.jsx(Mu,{children:"🧺 Waschküche auf Vordermann bringen"}),r.jsx(ku,{children:"Unsere treuen Waschgeräte haben jahrelang gute Arbeit geleistet. Moderne, energieeffiziente Nachfolger würden nicht nur die Umwelt schonen, sondern auch die Pflege unserer Trikots optimieren."})]})]})]}),r.jsxs(SS,{children:[r.jsx(jS,{children:"✨ Unsere Pläne für den Fürstenberg"}),r.jsxs(wS,{children:[r.jsxs(Du,{children:[r.jsx(Ou,{children:"🪑"}),r.jsx(Bu,{children:"Kabinen sanieren"}),r.jsx(Nu,{children:"Neue Bänke einbauen, Böden erneuern, Belüchtung modernisieren und eine freundliche Atmosphäre schaffen."}),r.jsx(Uu,{children:"~8.000 €"})]}),r.jsxs(Du,{children:[r.jsx(Ou,{children:"🎨"}),r.jsx(Bu,{children:"Fassade & Fenster erneuern"}),r.jsx(Nu,{children:"Putz erneuern, professionell streichen, neue Fenster einbauen, SCKW-Logo anbringen und Sponsoren-Namen prominent platzieren für maximale Sichtbarkeit."}),r.jsx(Uu,{children:"~15.000 €"})]}),r.jsxs(Du,{children:[r.jsx(Ou,{children:"🧺"}),r.jsx(Bu,{children:"Waschküche modernisieren"}),r.jsx(Nu,{children:"Die vorhandenen Geräte durch moderne, energieeffiziente Waschmaschine und Trockner ersetzen für eine optimale Pflege der Sportkleidung."}),r.jsx(Uu,{children:"~5.000 €"})]})]})]}),r.jsxs(_S,{children:[r.jsx(ES,{children:"🤝 Werden Sie Renovierungs-Partner!"}),r.jsx(zS,{children:"Als Renovierungs-Sponsor erhalten Sie nicht nur steuerliche Vorteile, sondern auch prominent sichtbare Anerkennung direkt an unserem Sportplatz!"}),r.jsxs(CS,{children:[r.jsxs(vs,{children:[r.jsx(Ss,{children:"🏆"}),r.jsxs(js,{children:[r.jsx("strong",{children:"Namensschild an der Fassade:"})," Ihr Firmenname wird dauerhaft und gut sichtbar an der renovierten Außenfassade angebracht"]})]}),r.jsxs(vs,{children:[r.jsx(Ss,{children:"📄"}),r.jsxs(js,{children:[r.jsx("strong",{children:"Spendenquittung:"})," Alle Spenden sind steuerlich absetzbar - wir stellen Ihnen gerne eine Quittung aus"]})]}),r.jsxs(vs,{children:[r.jsx(Ss,{children:"📱"}),r.jsxs(js,{children:[r.jsx("strong",{children:"Social Media Dank:"})," Wir danken Ihnen öffentlich auf unseren Kanälen mit über 4.000 Followern"]})]}),r.jsxs(vs,{children:[r.jsx(Ss,{children:"🎯"}),r.jsxs(js,{children:[r.jsx("strong",{children:"Maximale Sichtbarkeit:"})," Die Fassade liegt direkt am Eingang - jeder Besucher sieht Ihren Namen"]})]})]})]}),r.jsxs(AS,{children:[r.jsx(TS,{children:"🤝 Gemeinsam für den Fürstenberg"}),r.jsx(RS,{children:"Jeder Beitrag macht einen Unterschied. Ob 50€ oder 5.000€ - gemeinsam können wir unserem Kultplatz das geben, was er verdient."}),r.jsx(W5,{realTime:!0}),r.jsxs(MS,{children:[r.jsx(r0,{className:"primary",href:"https://www.paypal.com/donate/?hosted_button_id=NRFWJ3SGN37XW",target:"_blank",rel:"noopener noreferrer",children:"💳 Mit PayPal spenden"}),r.jsx(r0,{href:"#",onClick:g,children:"🏦 Per Überweisung spenden"})]})]})]}),r.jsx(Is,{}),v&&r.jsx(kS,{onClick:()=>p(!1),children:r.jsxs(DS,{onClick:S=>S.stopPropagation(),children:[r.jsxs(OS,{children:[r.jsx(BS,{children:"Kontoverbindung für Spenden"}),r.jsx(NS,{onClick:()=>p(!1),children:"×"})]}),r.jsxs(US,{children:[r.jsxs(Lu,{children:[r.jsx(Hu,{children:"Kontoinhaber:"}),r.jsx(Gu,{children:"SC Konstanz-Wollmatingen"})]}),r.jsxs(Lu,{children:[r.jsx(Hu,{children:"IBAN:"}),r.jsx(Gu,{children:"DE12 6905 0001 0000 0228 06"})]}),r.jsxs(Lu,{children:[r.jsx(Hu,{children:"BIC:"}),r.jsx(Gu,{children:"SOLADES1KNZ"})]})]}),r.jsx(LS,{onClick:x,children:"📋 IBAN kopieren"}),r.jsx(HS,{children:"Klicken Sie außerhalb dieses Fensters oder auf × zum Schließen"})]})}),a&&r.jsx(GS,{images:u,initialIndex:f,onClose:()=>s(!1)})]})}const $u={text:"Meister & Aufsteiger!",highlight:"Verbandsliga Südbaden",suffix:"Ab Saison 26/27 spielen wir eine Liga höher!"},Of=[{value:"1,3 Mio.",label:"Social-Media-Views / Saison",description:"IG 1,07 Mio. + FB 203K kombiniert (Jul 25 - Jun 26)"},{value:"310.000",label:"Views / Monat aktuell",description:"IG 230K + FB 81K kombiniert (28 Tage, Mai-Jun 26)"},{value:"21.400",label:"Personen erreicht / Monat",description:"Instagram Reach, 97% Non-Followers"},{value:"60.000+",label:"Website-Aufrufe / Jahr",description:"23.800 Sessions, Ø 2:19 Min. Verweildauer"}],$S=[{id:"hauptsponsor",name:"Hauptsponsor",preis:"15.000 €",topFeature:"Trikotbrust",trikot:"Brust (bis 400 cm²)",bande:"9 m",banner:"1× XL (3 × 2 m)",magazin:"1 Seite",saisonkarten:10,vergeben:!0,sponsorName:"Fuchsbau Immobilien",sponsorLogo:"/sponsors/fuchsbau-logo.png",sponsorWebsite:"https://immofuchsbau.com/"},{id:"stadionname",name:"Stadionname-Partner",preis:"12.000 €",topFeature:"Namensrecht Stadion",trikot:"–",bande:"6 m",banner:"1× Standard (2 × 1,5 m)",magazin:"1/2 Seite",saisonkarten:10,vergeben:!1},{id:"co-sponsor-1",name:"Co-Sponsor I",preis:"9.500 €",topFeature:"Trikot-Rücken",trikot:"Rücken (bis 200 cm²)",bande:"6 m",banner:"1× Standard (2 × 1,5 m)",magazin:"1/2 Seite",saisonkarten:5,vergeben:!1},{id:"co-sponsor-2",name:"Co-Sponsor II",preis:"8.000 €",topFeature:"Trikot-Ärmel",trikot:"Ärmel (2 × 100 cm²)",bande:"6 m",banner:"1× Standard (2 × 1,5 m)",magazin:"1/2 Seite",saisonkarten:5,vergeben:!1}],VS=[{name:"Einzelbande",groesse:"3 × 1 m",preis:"800 €",slots:25,kategorie:"bande"},{name:"Doppelbande",groesse:"6 × 1 m",preis:"1.400 €",slots:12,kategorie:"bande"},{name:"Banner Standard",groesse:"ca. 2 × 1,5 m",preis:"1.200 €",slots:10,kategorie:"banner"},{name:"Banner XL",groesse:"ca. 3 × 2 m",preis:"2.000 €",slots:4,kategorie:"banner"}],qS=[{name:"Ballspende",beschreibung:"Durchsage vor Spiel, bei jedem Tor & Halbzeit · 1 Insta-Story",preis:"150 € / Spiel",hinweis:"5er-Pack: 500 €"},{name:"Spielpräsentator",beschreibung:"Alle Aufstellungen & Auswechslungen im Firmennamen",preis:"ab 250 € / Spiel"},{name:"Magazin-Inserat",beschreibung:"15 Ausgaben/Saison · ca. 100 Exemplare + 1.000-1.500 Online-Zugriffe",preis:"250 - 1.000 €",hinweis:"1/4 Seite 250 € · 1/2 Seite 500 € · 1 Seite 1.000 €"}],KS=[{label:"Pro Tor",starter:"100 €",premium:"200 €",kombi:"Fix + 150 €"},{label:"Pro Punkt",starter:"150 €",premium:"250 €",kombi:"Fix + 200 €"},{label:"Pro Zu-Null",starter:"300 €",premium:"500 €",kombi:"Fix + 400 €"},{label:"Pro Sieg",starter:"-",premium:"800 €",kombi:"Fix + 600 €"}],Vu={starter:"~5.000 €",premium:"~12.000 €",kombi:"~9.000 €"},_1=[{position:"Motorhaube",groesse:"100 x 65 cm",preis:"1.000 €"},{position:"Heckfläche gesamt (Doppeltür)",groesse:"180 x 170 cm",preis:"2.000 €"},{position:"Heckfläche pro Tür",groesse:"80 x 160 cm",preis:"je 1.000 €"},{position:"Seitenfläche groß (links)",groesse:"350 x 70 cm",preis:"1.500 €"},{position:"Seitenfläche groß (rechts)",groesse:"350 x 70 cm",preis:"1.500 €"},{position:"Schiebetür",groesse:"130 x 150 cm",preis:"1.200 €"}],E1=[{position:"Fensterstreifen (umlaufend)",groesse:"15-20 cm Höhe",preis:"800 €"},{position:"Heckstreifen",groesse:"170 x 20 cm",preis:"600 €"},{position:"Dachfläche (optional)",groesse:"200 x 150 cm",preis:"1.000 €"}],z1=["Mehrjahresrabatt: 10% (2 Jahre), 15% (3 Jahre)","Kombi-Paket Online + Bus: +150 € (Logo & Link auf Website)","Design & Folierung: optionaler Kostenbeitrag (50-100 €)","Social-Media-Add-on: +200 € für 1 dedizierten Post/Jahr"],vt={email:"sponsoring@sckw.de",adresse:{name:"SC Konstanz-Wollmatingen e.V.",strasse:"Schleyerweg 5",plz:"D-78467",ort:"Konstanz"},vollAdresse:`SC Konstanz-Wollmatingen e.V.
Schleyerweg 5
D-78467 Konstanz`},QS=[{label:"Firma / Organisation",type:"text",lines:1},{label:"Ansprechpartner",type:"text",lines:1},{label:"Telefon / E-Mail",type:"text",lines:1},{label:"Interessiert an (Paket/Leistung)",type:"text",lines:2},{label:"Budget-Rahmen",type:"text",lines:1},{label:"Notizen / Besonderheiten",type:"text",lines:4},{label:"Nächste Schritte / Follow-up",type:"text",lines:2}],XS=y.div`
  max-width: 1000px;
  margin: 0 auto;
`,ZS=y.div`
  display: flex;
...
`,nj=y.div`
  ...
  font-weight: 600;
  line-height: 1.3;
`,aj={hauptsponsor:{name:"Fuchsbau Immobilien",logo:"/sponsors/fuchsbau-logo.png",website:"https://immofuchsbau.com/"},partners:[{name:"Tasty Delivery",logo:"/sponsors/tasty.png",website:"https://tasty-delivery.de"},{name:"Stadtwerke Konstanz",logo:"/sponsors/Stadtwerke.avif",website:"https://www.stadtwerke-konstanz.de/"},{name:"Graf Hardenberg",logo:"/sponsors/grafhardenberg.png",website:"https://www.grafhardenberg.de/"},{name:"Kountz",logo:"/sponsors/KOUNTZ.avif",website:"#"},{name:"Rothaus",logo:"/sponsors/Rothaus.avif",website:"https://www.rothaus.de/"},{name:"J&C",logo:"/sponsors/JC.avif",website:"#"},{name:"Danlin Media",logo:"/sponsors/DANLIN.avif",website:"#"},{name:"Logan's Linde",logo:"/sponsors/logans.png",website:"https://logans-wollmatingen.de/"}]};function lj(){const{hauptsponsor:a,partners:s}=aj;return r.jsxs(XS,{children:[r.jsx(ZS,{children:r.jsxs(PS,{href:a.website,target:"_blank",rel:"noopener noreferrer",children:[r.jsx(FS,{children:"Hauptsponsor"}),r.jsx(JS,{src:a.logo,alt:a.name}),r.jsx(WS,{children:a.name})]})}),r.jsx(IS,{children:s.map((u,c)=>r.jsxs(ej,{href:u.website,target:"_blank",rel:"noopener noreferrer",children:[r.jsx(tj,{src:u.logo,alt:u.name}),r.jsx(nj,{children:u.name})]},c))})]})}const rj=y.div`
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));
  gap: 1.25rem;
...
`,e4=y.div`
  ...
  display: flex;
  justify-content: center;
`;function t4(){return r.jsxs(r.Fragment,{children:[r.jsx(I_,{}),r.jsx(e4,{children:r.jsx(G_,{})})]})}function n4(){const{pathname:a,hash:s}=on();return C.useEffect(()=>{if(!s){window.scrollTo(0,0);return}const u=decodeURIComponent(s.slice(1));let c=0,f=0,d=0;const v=()=>{const p=document.getElementById(u);p?(p.scrollIntoView({block:"start"}),d=window.setTimeout(()=>p.scrollIntoView({block:"start"}),400)):c++<20&&(f=window.setTimeout(v,100))};return v(),()=>{window.clearTimeout(f),window.clearTimeout(d)}},[a,s]),null}function a4(){return r.jsxs($2,{children:[r.jsx(n4,{}),r.jsxs(x2,{children:[r.jsx(ln,{path:"/",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(Ms,{to:"/sponsoring",replace:!0})]})}),r.jsx(ln,{path:"/sponsoring",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(yw,{})]})}),r.jsx(ln,{path:"/sponsoring-handoff",element:r.jsx(Zw,{})}),r.jsx(ln,{path:"/widget",element:r.jsx(t4,{})}),r.jsx(ln,{path:"/sponsoring/club-500",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(g_,{})]})}),r.jsx(ln,{path:"/sponsoring/pakete",element:r.jsx(Ms,{to:"/sponsoring#angebot",replace:!0})}),r.jsx(ln,{path:"/sponsoring/spielerpatenschaft",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(b_,{})]})}),r.jsx(ln,{path:"/mockup-generator",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(d6,{})]})}),r.jsx(ln,{path:"/renovierung",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(YS,{})]})}),r.jsx(ln,{path:"*",element:r.jsx(Ms,{to:"/sponsoring",replace:!0})})]})]})}console.log("sckw sponsoring Website loaded");Ay.createRoot(document.getElementById("root")).render(r.jsx(C.StrictMode,{children:r.jsx(zv,{theme:ni,children:r.jsx(a4,{})})}));
