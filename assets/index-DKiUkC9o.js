 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Mg;function xb(){if(Mg)return ie;Mg=1;var l=Symbol.for("react.transitional.element"),u=Symbol.for("react.portal"),c=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),d=Symbol.for("react.profiler"),g=Symbol.for("react.consumer"),p=Symbol.for("react.context"),j=Symbol.for("react.forward_ref"),v=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),R=Symbol.iterator;function D(x){return x===null||typeof x!="object"?null:(x=R&&x[R]||x["@@iterator"],typeof x=="function"?x:null)}var H={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},G=Object.assign,L={};function X(x,k,Y){this.props=x,this.context=k,this.refs=L,this.updater=Y||H}X.prototype.isReactComponent={},X.prototype.setState=function(x,k){if(typeof x!="object"&&typeof x!="function"&&x!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,x,k,"setState")},X.prototype.forceUpdate=function(x){this.updater.enqueueForceUpdate(this,x,"forceUpdate")};function U(){}U.prototype=X.prototype;function $(x,k,Y){this.props=x,this.context=k,this.refs=L,this.updater=Y||H}var Q=$.prototype=new U;Q.constructor=$,G(Q,X.prototype),Q.isPureReactComponent=!0;var ae=Array.isArray,Z={H:null,A:null,T:null,S:null,V:null},le=Object.prototype.hasOwnProperty;function W(x,k,Y,V,F,ce){return Y=ce.ref,{$$typeof:l,type:x,key:k,ref:Y!==void 0?Y:null,props:ce}}function we(x,k){return W(x.type,k,void 0,void 0,void 0,x.props)}function _e(x){return typeof x=="object"&&x!==null&&x.$$typeof===l}function at(x){var k={"=":"=0",":":"=2"};return"$"+x.replace(/[=:]/g,function(Y){return k[Y]})}var it=/\/+/g;function Ye(x,k){return typeof x=="object"&&x!==null&&x.key!=null?at(""+x.key):k.toString(36)}function Zt(){}function Kt(x){switch(x.status){case"fulfilled":return x.value;case"rejected":throw x.reason;default:switch(typeof x.status=="string"?x.then(Zt,Zt):(x.status="pending",x.then(function(k){x.status==="pending"&&(x.status="fulfilled",x.value=k)},function(k){x.status==="pending"&&(x.status="rejected",x.reason=k)})),x.status){case"fulfilled":return x.value;case"rejected":throw x.reason}}throw x}function qe(x,k,Y,V,F){var ce=typeof x;(ce==="undefined"||ce==="boolean")&&(x=null);var ee=!1;if(x===null)ee=!0;else switch(ce){case"bigint":case"string":case"number":ee=!0;break;case"object":switch(x.$$typeof){case l:case u:ee=!0;break;case w:return ee=x._init,qe(ee(x._payload),k,Y,V,F)}}if(ee)return F=F(x),ee=V===""?"."+Ye(x,0):V,ae(F)?(Y="",ee!=null&&(Y=ee.replace(it,"$&/")+"/"),qe(F,k,Y,"",function(Pe){return Pe})):F!=null&&(_e(F)&&(F=we(F,Y+(F.key==null||x&&x.key===F.key?"":(""+F.key).replace(it,"$&/")+"/")+ee)),k.push(F)),1;ee=0;var Ve=V===""?".":V+":";if(ae(x))for(var pe=0;pe<x.length;pe++)V=x[pe],ce=Ve+Ye(V,pe),ee+=qe(V,k,Y,ce,F);else if(pe=D(x),typeof pe=="function")for(x=pe.call(x),pe=0;!(V=x.next()).done;)V=V.value,ce=Ve+Ye(V,pe++),ee+=qe(V,k,Y,ce,F);else if(ce==="object"){if(typeof x.then=="function")return qe(Kt(x),k,Y,V,F);throw k=String(x),Error("Objects are not valid as a React child (found: "+(k==="[object Object]"?"object with keys {"+Object.keys(x).join(", ")+"}":k)+"). If you meant to render a collection of children, use an array instead.")}return ee}function O(x,k,Y){if(x==null)return x;var V=[],F=0;return qe(x,V,"","",function(ce){return k.call(Y,ce,F++)}),V}function q(x){if(x._status===-1){var k=x._result;k=k(),k.then(function(Y){(x._status===0||x._status===-1)&&(x._status=1,x._result=Y)},function(Y){(x._status===0||x._status===-1)&&(x._status=2,x._result=Y)}),x._status===-1&&(x._status=0,x._result=k)}if(x._status===1)return x._result.default;throw x._result}var P=typeof reportError=="function"?reportError:function(x){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var k=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof x=="object"&&x!==null&&typeof x.message=="string"?String(x.message):String(x),error:x});if(!window.dispatchEvent(k))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",x);return}console.error(x)};function oe(){}return ie.Children={map:O,forEach:function(x,k,Y){O(x,function(){k.apply(this,arguments)},Y)},count:function(x){var k=0;return O(x,function(){k++}),k},toArray:function(x){return O(x,function(k){return k})||[]},only:function(x){if(!_e(x))throw Error("React.Children.only expected to receive a single React element child.");return x}},ie.Component=X,ie.Fragment=c,ie.Profiler=d,ie.PureComponent=$,ie.StrictMode=s,ie.Suspense=v,ie.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=Z,ie.__COMPILER_RUNTIME={__proto__:null,c:function(x){return Z.H.useMemoCache(x)}},ie.cache=function(x){return function(){return x.apply(null,arguments)}},ie.cloneElement=function(x,k,Y){if(x==null)throw Error("The argument must be a React element, but you passed "+x+".");var V=G({},x.props),F=x.key,ce=void 0;if(k!=null)for(ee in k.ref!==void 0&&(ce=void 0),k.key!==void 0&&(F=""+k.key),k)!le.call(k,ee)||ee==="key"||ee==="__self"||ee==="__source"||ee==="ref"&&k.ref===void 0||(V[ee]=k[ee]);var ee=arguments.length-2;if(ee===1)V.children=Y;else if(1<ee){for(var Ve=Array(ee),pe=0;pe<ee;pe++)Ve[pe]=arguments[pe+2];V.children=Ve}return W(x.type,F,void 0,void 0,ce,V)},ie.createContext=function(x){return x={$$typeof:p,_currentValue:x,_currentValue2:x,_threadCount:0,Provider:null,Consumer:null},x.Provider=x,x.Consumer={$$typeof:g,_context:x},x},ie.createElement=function(x,k,Y){var V,F={},ce=null;if(k!=null)for(V in k.key!==void 0&&(ce=""+k.key),k)le.call(k,V)&&V!=="key"&&V!=="__self"&&V!=="__source"&&(F[V]=k[V]);var ee=arguments.length-2;if(ee===1)F.children=Y;else if(1<ee){for(var Ve=Array(ee),pe=0;pe<ee;pe++)Ve[pe]=arguments[pe+2];F.children=Ve}if(x&&x.defaultProps)for(V in ee=x.defaultProps,ee)F[V]===void 0&&(F[V]=ee[V]);return W(x,ce,void 0,void 0,null,F)},ie.createRef=function(){return{current:null}},ie.forwardRef=function(x){return{$$typeof:j,render:x}},ie.isValidElement=_e,ie.lazy=function(x){return{$$typeof:w,_payload:{_status:-1,_result:x},_init:q}},ie.memo=function(x,k){return{$$typeof:m,type:x,compare:k===void 0?null:k}},ie.startTransition=function(x){var k=Z.T,Y={};Z.T=Y;try{var V=x(),F=Z.S;F!==null&&F(Y,V),typeof V=="object"&&V!==null&&typeof V.then=="function"&&V.then(oe,P)}catch(ce){P(ce)}finally{Z.T=k}},ie.unstable_useCacheRefresh=function(){return Z.H.useCacheRefresh()},ie.use=function(x){return Z.H.use(x)},ie.useActionState=function(x,k,Y){return Z.H.useActionState(x,k,Y)},ie.useCallback=function(x,k){return Z.H.useCallback(x,k)},ie.useContext=function(x){return Z.H.useContext(x)},ie.useDebugValue=function(){},ie.useDeferredValue=function(x,k){return Z.H.useDeferredValue(x,k)},ie.useEffect=function(x,k,Y){var V=Z.H;if(typeof Y=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return V.useEffect(x,k)},ie.useId=function(){return Z.H.useId()},ie.useImperativeHandle=function(x,k,Y){return Z.H.useImperativeHandle(x,k,Y)},ie.useInsertionEffect=function(x,k){return Z.H.useInsertionEffect(x,k)},ie.useLayoutEffect=function(x,k){return Z.H.useLayoutEffect(x,k)},ie.useMemo=function(x,k){return Z.H.useMemo(x,k)},ie.useOptimistic=function(x,k){return Z.H.useOptimistic(x,k)},ie.useReducer=function(x,k,Y){return Z.H.useReducer(x,k,Y)},ie.useRef=function(x){return Z.H.useRef(x)},ie.useState=function(x){return Z.H.useState(x)},ie.useSyncExternalStore=function(x,k,Y){return Z.H.useSyncExternalStore(x,k,Y)},ie.useTransition=function(){return Z.H.useTransition()},ie.version="19.1.0",ie}var Dg;function vc(){return Dg||(Dg=1,To.exports=xb()),To.exports}var M=vc();const sa=bb(M);var Ao={exports:{}},gi={},Ro={exports:{}},Mo={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Og;function Sb(){return Og||(Og=1,function(l){function u(O,q){var P=O.length;O.push(q);e:for(;0<P;){var oe=P-1>>>1,x=O[oe];if(0<d(x,q))O[oe]=q,O[P]=x,P=oe;else break e}}function c(O){return O.length===0?null:O[0]}function s(O){if(O.length===0)return null;var q=O[0],P=O.pop();if(P!==q){O[0]=P;e:for(var oe=0,x=O.length,k=x>>>1;oe<k;){var Y=2*(oe+1)-1,V=O[Y],F=Y+1,ce=O[F];if(0>d(V,P))F<x&&0>d(ce,V)?(O[oe]=ce,O[F]=P,oe=F):(O[oe]=V,O[Y]=P,oe=Y);else if(F<x&&0>d(ce,P))O[oe]=ce,O[F]=P,oe=F;else break e}}return q}function d(O,q){var P=O.sortIndex-q.sortIndex;return P!==0?P:O.id-q.id}if(l.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var g=performance;l.unstable_now=function(){return g.now()}}else{var p=Date,j=p.now();l.unstable_now=function(){return p.now()-j}}var v=[],m=[],w=1,R=null,D=3,H=!1,G=!1,L=!1,X=!1,U=typeof setTimeout=="function"?setTimeout:null,$=typeof clearTimeout=="function"?clearTimeout:null,Q=typeof setImmediate<"u"?setImmediate:null;function ae(O){for(var q=c(m);q!==null;){if(q.callback===null)s(m);else if(q.startTime<=O)s(m),q.sortIndex=q.expirationTime,u(v,q);else break;q=c(m)}}function Z(O){if(L=!1,ae(O),!G)if(c(v)!==null)G=!0,le||(le=!0,Ye());else{var q=c(m);q!==null&&qe(Z,q.startTime-O)}}var le=!1,W=-1,we=5,_e=-1;function at(){return X?!0:!(l.unstable_now()-_e<we)}function it(){if(X=!1,le){var O=l.unstable_now();_e=O;var q=!0;try{e:{G=!1,L&&(L=!1,$(W),W=-1),H=!0;var P=D;try{t:{for(ae(O),R=c(v);R!==null&&!(R.expirationTime>O&&at());){var oe=R.callback;if(typeof oe=="function"){R.callback=null,D=R.priorityLevel;var x=oe(R.expirationTime<=O);if(O=l.unstable_now(),typeof x=="function"){R.callback=x,ae(O),q=!0;break t}R===c(v)&&s(v),ae(O)}else s(v);R=c(v)}if(R!==null)q=!0;else{var k=c(m);k!==null&&qe(Z,k.startTime-O),q=!1}}break e}finally{R=null,D=P,H=!1}q=void 0}}finally{q?Ye():le=!1}}}var Ye;if(typeof Q=="function")Ye=function(){Q(it)};else if(typeof MessageChannel<"u"){var Zt=new MessageChannel,Kt=Zt.port2;Zt.port1.onmessage=it,Ye=function(){Kt.postMessage(null)}}else Ye=function(){U(it,0)};function qe(O,q){W=U(function(){O(l.unstable_now())},q)}l.unstable_IdlePriority=5,l.unstable_ImmediatePriority=1,l.unstable_LowPriority=4,l.unstable_NormalPriority=3,l.unstable_Profiling=null,l.unstable_UserBlockingPriority=2,l.unstable_cancelCallback=function(O){O.callback=null},l.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):we=0<O?Math.floor(1e3/O):5},l.unstable_getCurrentPriorityLevel=function(){return D},l.unstable_next=function(O){switch(D){case 1:case 2:case 3:var q=3;break;default:q=D}var P=D;D=q;try{return O()}finally{D=P}},l.unstable_requestPaint=function(){X=!0},l.unstable_runWithPriority=function(O,q){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var P=D;D=O;try{return q()}finally{D=P}},l.unstable_scheduleCallback=function(O,q,P){var oe=l.unstable_now();switch(typeof P=="object"&&P!==null?(P=P.delay,P=typeof P=="number"&&0<P?oe+P:oe):P=oe,O){case 1:var x=-1;break;case 2:x=250;break;case 5:x=1073741823;break;case 4:x=1e4;break;default:x=5e3}return x=P+x,O={id:w++,callback:q,priorityLevel:O,startTime:P,expirationTime:x,sortIndex:-1},P>oe?(O.sortIndex=P,u(m,O),c(v)===null&&O===c(m)&&(L?($(W),W=-1):L=!0,qe(Z,P-oe))):(O.sortIndex=x,u(v,O),G||H||(G=!0,le||(le=!0,Ye()))),O},l.unstable_shouldYield=at,l.unstable_wrapCallback=function(O){var q=D;return function(){var P=D;D=q;try{return O.apply(this,arguments)}finally{D=P}}}}(Mo)),Mo}var Cg;function jb(){return Cg||(Cg=1,Ro.exports=Sb()),Ro.exports}var Do={exports:{}},tt={};/**
 * @license React
 ...
 *
 * @license MIT
 */var Ig="popstate";function Dy(l={}){function u(s,d){let{pathname:g,search:p,hash:j}=s.location;return bc("",{pathname:g,search:p,hash:j},d.state&&d.state.usr||null,d.state&&d.state.key||"default")}function c(s,d){return typeof d=="string"?d:Si(d)}return Cy(u,c,null,l)}function Me(l,u){if(l===!1||l===null||typeof l>"u")throw new Error(u)}function kt(l,u){if(!l){typeof console<"u"&&console.warn(u);try{throw new Error(u)}catch{}}}function Oy(){return Math.random().toString(36).substring(2,10)}function em(l,u){return{usr:l.state,key:l.key,idx:u}}function bc(l,u,c=null,s){return{pathname:typeof l=="string"?l:l.pathname,search:"",hash:"",...typeof u=="string"?hl(u):u,state:c,key:u&&u.key||s||Oy()}}function Si({pathname:l="/",search:u="",hash:c=""}){return u&&u!=="?"&&(l+=u.charAt(0)==="?"?u:"?"+u),c&&c!=="#"&&(l+=c.charAt(0)==="#"?c:"#"+c),l}function hl(l){let u={};if(l){let c=l.indexOf("#");c>=0&&(u.hash=l.substring(c),l=l.substring(0,c));let s=l.indexOf("?");s>=0&&(u.search=l.substring(s),l=l.substring(0,s)),l&&(u.pathname=l)}return u}function Cy(l,u,c,s={}){let{window:d=document.defaultView,v5Compat:g=!1}=s,p=d.history,j="POP",v=null,m=w();m==null&&(m=0,p.replaceState({...p.state,idx:m},""));function w(){return(p.state||{idx:null}).idx}function R(){j="POP";let X=w(),U=X==null?null:X-m;m=X,v&&v({action:j,location:L.location,delta:U})}function D(X,U){j="PUSH";let $=bc(L.location,X,U);m=w()+1;let Q=em($,m),ae=L.createHref($);try{p.pushState(Q,"",ae)}catch(Z){if(Z instanceof DOMException&&Z.name==="DataCloneError")throw Z;d.location.assign(ae)}g&&v&&v({action:j,location:L.location,delta:1})}function H(X,U){j="REPLACE";let $=bc(L.location,X,U);m=w();let Q=em($,m),ae=L.createHref($);p.replaceState(Q,"",ae),g&&v&&v({action:j,location:L.location,delta:0})}function G(X){return By(X)}let L={get action(){return j},get location(){return l(d,p)},listen(X){if(v)throw new Error("A history only accepts one active listener");return d.addEventListener(Ig,R),v=X,()=>{d.removeEventListener(Ig,R),v=null}},createHref(X){return u(d,X)},createURL:G,encodeLocation(X){let U=G(X);return{pathname:U.pathname,search:U.search,hash:U.hash}},push:D,replace:H,go(X){return p.go(X)}};return L}function By(l,u=!1){let c="http://localhost";typeof window<"u"&&(c=window.location.origin!=="null"?window.location.origin:window.location.href),Me(c,"No window.location.(origin|href) available to create URL");let s=typeof l=="string"?l:Si(l);return s=s.replace(/ $/,"%20"),!u&&s.startsWith("//")&&(s=c+s),new URL(s,c)}function Um(l,u,c="/"){return Ny(l,u,c,!1)}function Ny(l,u,c,s){let d=typeof u=="string"?hl(u):u,g=hn(d.pathname||"/",c);if(g==null)return null;let p=Hm(l);ky(p);let j=null;for(let v=0;j==null&&v<p.length;++v){let m=Ky(g);j=Qy(p[v],m,s)}return j}function Hm(l,u=[],c=[],s=""){let d=(g,p,j)=>{let v={relativePath:j===void 0?g.path||"":j,caseSensitive:g.caseSensitive===!0,childrenIndex:p,route:g};v.relativePath.startsWith("/")&&(Me(v.relativePath.startsWith(s),`Absolute route path "${v.relativePath}" nested under path "${s}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),v.relativePath=v.relativePath.slice(s.length));let m=dn([s,v.relativePath]),w=c.concat(v);g.children&&g.children.length>0&&(Me(g.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${m}".`),Hm(g.children,u,w,m)),!(g.path==null&&!g.index)&&u.push({path:m,score:Vy(m,g.index),routesMeta:w})};return l.forEach((g,p)=>{if(g.path===""||!g.path?.includes("?"))d(g,p);else for(let j of Gm(g.path))d(g,p,j)}),u}function Gm(l){let u=l.split("/");if(u.length===0)return[];let[c,...s]=u,d=c.endsWith("?"),g=c.replace(/\?$/,"");if(s.length===0)return d?[g,""]:[g];let p=Gm(s.join("/")),j=[];return j.push(...p.map(v=>v===""?g:[g,v].join("/"))),d&&j.push(...p),j.map(v=>l.startsWith("/")&&v===""?"/":v)}function ky(l){l.sort((u,c)=>u.score!==c.score?c.score-u.score:Xy(u.routesMeta.map(s=>s.childrenIndex),c.routesMeta.map(s=>s.childrenIndex)))}var Uy=/^:[\w-]+$/,Hy=3,Gy=2,Ly=1,Yy=10,qy=-2,tm=l=>l==="*";function Vy(l,u){let c=l.split("/"),s=c.length;return c.some(tm)&&(s+=qy),u&&(s+=Gy),c.filter(d=>!tm(d)).reduce((d,g)=>d+(Uy.test(g)?Hy:g===""?Ly:Yy),s)}function Xy(l,u){return l.length===u.length&&l.slice(0,-1).every((s,d)=>s===u[d])?l[l.length-1]-u[u.length-1]:0}function Qy(l,u,c=!1){let{routesMeta:s}=l,d={},g="/",p=[];for(let j=0;j<s.length;++j){let v=s[j],m=j===s.length-1,w=g==="/"?u:u.slice(g.length)||"/",R=au({path:v.relativePath,caseSensitive:v.caseSensitive,end:m},w),D=v.route;if(!R&&m&&c&&!s[s.length-1].route.index&&(R=au({path:v.relativePath,caseSensitive:v.caseSensitive,end:!1},w)),!R)return null;Object.assign(d,R.params),p.push({params:d,pathname:dn([g,R.pathname]),pathnameBase:Fy(dn([g,R.pathnameBase])),route:D}),R.pathnameBase!=="/"&&(g=dn([g,R.pathnameBase]))}return p}function au(l,u){typeof l=="string"&&(l={path:l,caseSensitive:!1,end:!0});let[c,s]=Zy(l.path,l.caseSensitive,l.end),d=u.match(c);if(!d)return null;let g=d[0],p=g.replace(/(.)\/+$/,"$1"),j=d.slice(1);return{params:s.reduce((m,{paramName:w,isOptional:R},D)=>{if(w==="*"){let G=j[D]||"";p=g.slice(0,g.length-G.length).replace(/(.)\/+$/,"$1")}const H=j[D];return R&&!H?m[w]=void 0:m[w]=(H||"").replace(/%2F/g,"/"),m},{}),pathname:g,pathnameBase:p,pattern:l}}function Zy(l,u=!1,c=!0){kt(l==="*"||!l.endsWith("*")||l.endsWith("/*"),`Route path "${l}" will be treated as if it were "${l.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${l.replace(/\*$/,"/*")}".`);let s=[],d="^"+l.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(p,j,v)=>(s.push({paramName:j,isOptional:v!=null}),v?"/?([^\\/]+)?":"/([^\\/]+)"));return l.endsWith("*")?(s.push({paramName:"*"}),d+=l==="*"||l==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):c?d+="\\/*$":l!==""&&l!=="/"&&(d+="(?:(?=\\/|$))"),[new RegExp(d,u?void 0:"i"),s]}function Ky(l){try{return l.split("/").map(u=>decodeURIComponent(u).replace(/\//g,"%2F")).join("/")}catch(u){return kt(!1,`The URL path "${l}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${u}).`),l}}function hn(l,u){if(u==="/")return l;if(!l.toLowerCase().startsWith(u.toLowerCase()))return null;let c=u.endsWith("/")?u.length-1:u.length,s=l.charAt(c);return s&&s!=="/"?null:l.slice(c)||"/"}function Jy(l,u="/"){let{pathname:c,search:s="",hash:d=""}=typeof l=="string"?hl(l):l;return{pathname:c?c.startsWith("/")?c:$y(c,u):u,search:Py(s),hash:Iy(d)}}function $y(l,u){let c=u.replace(/\/+$/,"").split("/");return l.split("/").forEach(d=>{d===".."?c.length>1&&c.pop():d!=="."&&c.push(d)}),c.length>1?c.join("/"):"/"}function ko(l,u,c,s){return`Cannot include a '${l}' character in a manually specified \`to.${u}\` field [${JSON.stringify(s)}].  Please separate it out to the \`to.${c}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function Wy(l){return l.filter((u,c)=>c===0||u.route.path&&u.route.path.length>0)}function Ec(l){let u=Wy(l);return u.map((c,s)=>s===u.length-1?c.pathname:c.pathnameBase)}function wc(l,u,c,s=!1){let d;typeof l=="string"?d=hl(l):(d={...l},Me(!d.pathname||!d.pathname.includes("?"),ko("?","pathname","search",d)),Me(!d.pathname||!d.pathname.includes("#"),ko("#","pathname","hash",d)),Me(!d.search||!d.search.includes("#"),ko("#","search","hash",d)));let g=l===""||d.pathname==="",p=g?"/":d.pathname,j;if(p==null)j=c;else{let R=u.length-1;if(!s&&p.startsWith("..")){let D=p.split("/");for(;D[0]==="..";)D.shift(),R-=1;d.pathname=D.join("/")}j=R>=0?u[R]:"/"}let v=Jy(d,j),m=p&&p!=="/"&&p.endsWith("/"),w=(g||p===".")&&c.endsWith("/");return!v.pathname.endsWith("/")&&(m||w)&&(v.pathname+="/"),v}var dn=l=>l.join("/").replace(/\/\/+/g,"/"),Fy=l=>l.replace(/\/+$/,"").replace(/^\/*/,"/"),Py=l=>!l||l==="?"?"":l.startsWith("?")?l:"?"+l,Iy=l=>!l||l==="#"?"":l.startsWith("#")?l:"#"+l;function ev(l){return l!=null&&typeof l.status=="number"&&typeof l.statusText=="string"&&typeof l.internal=="boolean"&&"data"in l}var Lm=["POST","PUT","PATCH","DELETE"];new Set(Lm);var tv=["GET",...Lm];new Set(tv);var gl=M.createContext(null);gl.displayName="DataRouter";var cu=M.createContext(null);cu.displayName="DataRouterState";M.createContext(!1);var Ym=M.createContext({isTransitioning:!1});Ym.displayName="ViewTransition";var nv=M.createContext(new Map);nv.displayName="Fetchers";var av=M.createContext(null);av.displayName="Await";var Ut=M.createContext(null);Ut.displayName="Navigation";var ji=M.createContext(null);ji.displayName="Location";var Qt=M.createContext({outlet:null,matches:[],isDataRoute:!1});Qt.displayName="Route";var Tc=M.createContext(null);Tc.displayName="RouteError";function lv(l,{relative:u}={}){Me(ml(),"useHref() may be used only in the context of a <Router> component.");let{basename:c,navigator:s}=M.useContext(Ut),{hash:d,pathname:g,search:p}=_i(l,{relative:u}),j=g;return c!=="/"&&(j=g==="/"?c:dn([c,g])),s.createHref({pathname:j,search:p,hash:d})}function ml(){return M.useContext(ji)!=null}function gn(){return Me(ml(),"useLocation() may be used only in the context of a <Router> component."),M.useContext(ji).location}var qm="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Vm(l){M.useContext(Ut).static||M.useLayoutEffect(l)}function Xm(){let{isDataRoute:l}=M.useContext(Qt);return l?bv():iv()}function iv(){Me(ml(),"useNavigate() may be used only in the context of a <Router> component.");let l=M.useContext(gl),{basename:u,navigator:c}=M.useContext(Ut),{matches:s}=M.useContext(Qt),{pathname:d}=gn(),g=JSON.stringify(Ec(s)),p=M.useRef(!1);return Vm(()=>{p.current=!0}),M.useCallback((v,m={})=>{if(kt(p.current,qm),!p.current)return;if(typeof v=="number"){c.go(v);return}let w=wc(v,JSON.parse(g),d,m.relative==="path");l==null&&u!=="/"&&(w.pathname=w.pathname==="/"?u:dn([u,w.pathname])),(m.replace?c.replace:c.push)(w,m.state,m)},[u,c,g,d,l])}M.createContext(null);function _i(l,{relative:u}={}){let{matches:c}=M.useContext(Qt),{pathname:s}=gn(),d=JSON.stringify(Ec(c));return M.useMemo(()=>wc(l,JSON.parse(d),s,u==="path"),[l,d,s,u])}function rv(l,u){return Qm(l,u)}function Qm(l,u,c,s){Me(ml(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:d}=M.useContext(Ut),{matches:g}=M.useContext(Qt),p=g[g.length-1],j=p?p.params:{},v=p?p.pathname:"/",m=p?p.pathnameBase:"/",w=p&&p.route;{let U=w&&w.path||"";Zm(v,!w||U.endsWith("*")||U.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${v}" (under <Route path="${U}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${U}"> to <Route path="${U==="/"?"*":`${U}/*`}">.`)}let R=gn(),D;if(u){let U=typeof u=="string"?hl(u):u;Me(m==="/"||U.pathname?.startsWith(m),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${m}" but pathname "${U.pathname}" was given in the \`location\` prop.`),D=U}else D=R;let H=D.pathname||"/",G=H;if(m!=="/"){let U=m.replace(/^\//,"").split("/");G="/"+H.replace(/^\//,"").split("/").slice(U.length).join("/")}let L=Um(l,{pathname:G});kt(w||L!=null,`No routes matched location "${D.pathname}${D.search}${D.hash}" `),kt(L==null||L[L.length-1].route.element!==void 0||L[L.length-1].route.Component!==void 0||L[L.length-1].route.lazy!==void 0,`Matched leaf route at location "${D.pathname}${D.search}${D.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let X=fv(L&&L.map(U=>Object.assign({},U,{params:Object.assign({},j,U.params),pathname:dn([m,d.encodeLocation?d.encodeLocation(U.pathname).pathname:U.pathname]),pathnameBase:U.pathnameBase==="/"?m:dn([m,d.encodeLocation?d.encodeLocation(U.pathnameBase).pathname:U.pathnameBase])})),g,c,s);return u&&X?M.createElement(ji.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...D},navigationType:"POP"}},X):X}function uv(){let l=pv(),u=ev(l)?`${l.status} ${l.statusText}`:l instanceof Error?l.message:JSON.stringify(l),c=l instanceof Error?l.stack:null,s="rgba(200,200,200, 0.5)",d={padding:"0.5rem",backgroundColor:s},g={padding:"2px 4px",backgroundColor:s},p=null;return console.error("Error handled by React Router default ErrorBoundary:",l),p=M.createElement(M.Fragment,null,M.createElement("p",null,"💿 Hey developer 👋"),M.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",M.createElement("code",{style:g},"ErrorBoundary")," or"," ",M.createElement("code",{style:g},"errorElement")," prop on your route.")),M.createElement(M.Fragment,null,M.createElement("h2",null,"Unexpected Application Error!"),M.createElement("h3",{style:{fontStyle:"italic"}},u),c?M.createElement("pre",{style:d},c):null,p)}var sv=M.createElement(uv,null),ov=class extends M.Component{constructor(l){super(l),this.state={location:l.location,revalidation:l.revalidation,error:l.error}}static getDerivedStateFromError(l){return{error:l}}static getDerivedStateFromProps(l,u){return u.location!==l.location||u.revalidation!=="idle"&&l.revalidation==="idle"?{error:l.error,location:l.location,revalidation:l.revalidation}:{error:l.error!==void 0?l.error:u.error,location:u.location,revalidation:l.revalidation||u.revalidation}}componentDidCatch(l,u){console.error("React Router caught the following error during render",l,u)}render(){return this.state.error!==void 0?M.createElement(Qt.Provider,{value:this.props.routeContext},M.createElement(Tc.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function cv({routeContext:l,match:u,children:c}){let s=M.useContext(gl);return s&&s.static&&s.staticContext&&(u.route.errorElement||u.route.ErrorBoundary)&&(s.staticContext._deepestRenderedBoundaryId=u.route.id),M.createElement(Qt.Provider,{value:l},c)}function fv(l,u=[],c=null,s=null){if(l==null){if(!c)return null;if(c.errors)l=c.matches;else if(u.length===0&&!c.initialized&&c.matches.length>0)l=c.matches;else return null}let d=l,g=c?.errors;if(g!=null){let v=d.findIndex(m=>m.route.id&&g?.[m.route.id]!==void 0);Me(v>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(g).join(",")}`),d=d.slice(0,Math.min(d.length,v+1))}let p=!1,j=-1;if(c)for(let v=0;v<d.length;v++){let m=d[v];if((m.route.HydrateFallback||m.route.hydrateFallbackElement)&&(j=v),m.route.id){let{loaderData:w,errors:R}=c,D=m.route.loader&&!w.hasOwnProperty(m.route.id)&&(!R||R[m.route.id]===void 0);if(m.route.lazy||D){p=!0,j>=0?d=d.slice(0,j+1):d=[d[0]];break}}}return d.reduceRight((v,m,w)=>{let R,D=!1,H=null,G=null;c&&(R=g&&m.route.id?g[m.route.id]:void 0,H=m.route.errorElement||sv,p&&(j<0&&w===0?(Zm("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),D=!0,G=null):j===w&&(D=!0,G=m.route.hydrateFallbackElement||null)));let L=u.concat(d.slice(0,w+1)),X=()=>{let U;return R?U=H:D?U=G:m.route.Component?U=M.createElement(m.route.Component,null):m.route.element?U=m.route.element:U=v,M.createElement(cv,{match:m,routeContext:{outlet:v,matches:L,isDataRoute:c!=null},children:U})};return c&&(m.route.ErrorBoundary||m.route.errorElement||w===0)?M.createElement(ov,{location:c.location,revalidation:c.revalidation,component:H,error:R,children:X(),routeContext:{outlet:null,matches:L,isDataRoute:!0}}):X()},null)}function Ac(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function dv(l){let u=M.useContext(gl);return Me(u,Ac(l)),u}function hv(l){let u=M.useContext(cu);return Me(u,Ac(l)),u}function gv(l){let u=M.useContext(Qt);return Me(u,Ac(l)),u}function Rc(l){let u=gv(l),c=u.matches[u.matches.length-1];return Me(c.route.id,`${l} can only be used on routes that contain a unique "id"`),c.route.id}function mv(){return Rc("useRouteId")}function pv(){let l=M.useContext(Tc),u=hv("useRouteError"),c=Rc("useRouteError");return l!==void 0?l:u.errors?.[c]}function bv(){let{router:l}=dv("useNavigate"),u=Rc("useNavigate"),c=M.useRef(!1);return Vm(()=>{c.current=!0}),M.useCallback(async(d,g={})=>{kt(c.current,qm),c.current&&(typeof d=="number"?l.navigate(d):await l.navigate(d,{fromRouteId:u,...g}))},[l,u])}var nm={};function Zm(l,u,c){!u&&!nm[l]&&(nm[l]=!0,kt(!1,c))}M.memo(yv);function yv({routes:l,future:u,state:c}){return Qm(l,void 0,c,u)}function vv({to:l,replace:u,state:c,relative:s}){Me(ml(),"<Navigate> may be used only in the context of a <Router> component.");let{static:d}=M.useContext(Ut);kt(!d,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:g}=M.useContext(Qt),{pathname:p}=gn(),j=Xm(),v=wc(l,Ec(g),p,s==="path"),m=JSON.stringify(v);return M.useEffect(()=>{j(JSON.parse(m),{replace:u,state:c,relative:s})},[j,m,s,u,c]),null}function yi(l){Me(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function xv({basename:l="/",children:u=null,location:c,navigationType:s="POP",navigator:d,static:g=!1}){Me(!ml(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let p=l.replace(/^\/*/,"/"),j=M.useMemo(()=>({basename:p,navigator:d,static:g,future:{}}),[p,d,g]);typeof c=="string"&&(c=hl(c));let{pathname:v="/",search:m="",hash:w="",state:R=null,key:D="default"}=c,H=M.useMemo(()=>{let G=hn(v,p);return G==null?null:{location:{pathname:G,search:m,hash:w,state:R,key:D},navigationType:s}},[p,v,m,w,R,D,s]);return kt(H!=null,`<Router basename="${p}"> is not able to match the URL "${v}${m}${w}" because it does not start with the basename, so the <Router> won't render anything.`),H==null?null:M.createElement(Ut.Provider,{value:j},M.createElement(ji.Provider,{children:u,value:H}))}function Sv({children:l,location:u}){return rv(yc(l),u)}function yc(l,u=[]){let c=[];return M.Children.forEach(l,(s,d)=>{if(!M.isValidElement(s))return;let g=[...u,d];if(s.type===M.Fragment){c.push.apply(c,yc(s.props.children,g));return}Me(s.type===yi,`[${typeof s.type=="string"?s.type:s.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Me(!s.props.index||!s.props.children,"An index route cannot have child routes.");let p={id:s.props.id||g.join("-"),caseSensitive:s.props.caseSensitive,element:s.props.element,Component:s.props.Component,index:s.props.index,path:s.props.path,loader:s.props.loader,action:s.props.action,hydrateFallbackElement:s.props.hydrateFallbackElement,HydrateFallback:s.props.HydrateFallback,errorElement:s.props.errorElement,ErrorBoundary:s.props.ErrorBoundary,hasErrorBoundary:s.props.hasErrorBoundary===!0||s.props.ErrorBoundary!=null||s.props.errorElement!=null,shouldRevalidate:s.props.shouldRevalidate,handle:s.props.handle,lazy:s.props.lazy};s.props.children&&(p.children=yc(s.props.children,g)),c.push(p)}),c}var Wr="get",Fr="application/x-www-form-urlencoded";function fu(l){return l!=null&&typeof l.tagName=="string"}function jv(l){return fu(l)&&l.tagName.toLowerCase()==="button"}function _v(l){return fu(l)&&l.tagName.toLowerCase()==="form"}function zv(l){return fu(l)&&l.tagName.toLowerCase()==="input"}function Ev(l){return!!(l.metaKey||l.altKey||l.ctrlKey||l.shiftKey)}function wv(l,u){return l.button===0&&(!u||u==="_self")&&!Ev(l)}var Lr=null;function Tv(){if(Lr===null)try{new FormData(document.createElement("form"),0),Lr=!1}catch{Lr=!0}return Lr}var Av=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Uo(l){return l!=null&&!Av.has(l)?(kt(!1,`"${l}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Fr}"`),null):l}function Rv(l,u){let c,s,d,g,p;if(_v(l)){let j=l.getAttribute("action");s=j?hn(j,u):null,c=l.getAttribute("method")||Wr,d=Uo(l.getAttribute("enctype"))||Fr,g=new FormData(l)}else if(jv(l)||zv(l)&&(l.type==="submit"||l.type==="image")){let j=l.form;if(j==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let v=l.getAttribute("formaction")||j.getAttribute("action");if(s=v?hn(v,u):null,c=l.getAttribute("formmethod")||j.getAttribute("method")||Wr,d=Uo(l.getAttribute("formenctype"))||Uo(j.getAttribute("enctype"))||Fr,g=new FormData(j,l),!Tv()){let{name:m,type:w,value:R}=l;if(w==="image"){let D=m?`${m}.`:"";g.append(`${D}x`,"0"),g.append(`${D}y`,"0")}else m&&g.append(m,R)}}else{if(fu(l))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');c=Wr,s=null,d=Fr,p=l}return g&&d==="text/plain"&&(p=g,g=void 0),{action:s,method:c.toLowerCase(),encType:d,formData:g,body:p}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Mc(l,u){if(l===!1||l===null||typeof l>"u")throw new Error(u)}function Mv(l,u,c){let s=typeof l=="string"?new URL(l,typeof window>"u"?"server://singlefetch/":window.location.origin):l;return s.pathname==="/"?s.pathname=`_root.${c}`:u&&hn(s.pathname,u)==="/"?s.pathname=`${u.replace(/\/$/,"")}/_root.${c}`:s.pathname=`${s.pathname.replace(/\/$/,"")}.${c}`,s}async function Dv(l,u){if(l.id in u)return u[l.id];try{let c=await import(l.module);return u[l.id]=c,c}catch(c){return console.error(`Error loading route module \`${l.module}\`, reloading page...`),console.error(c),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Ov(l){return l==null?!1:l.href==null?l.rel==="preload"&&typeof l.imageSrcSet=="string"&&typeof l.imageSizes=="string":typeof l.rel=="string"&&typeof l.href=="string"}async function Cv(l,u,c){let s=await Promise.all(l.map(async d=>{let g=u.routes[d.route.id];if(g){let p=await Dv(g,c);return p.links?p.links():[]}return[]}));return Uv(s.flat(1).filter(Ov).filter(d=>d.rel==="stylesheet"||d.rel==="preload").map(d=>d.rel==="stylesheet"?{...d,rel:"prefetch",as:"style"}:{...d,rel:"prefetch"}))}function am(l,u,c,s,d,g){let p=(v,m)=>c[m]?v.route.id!==c[m].route.id:!0,j=(v,m)=>c[m].pathname!==v.pathname||c[m].route.path?.endsWith("*")&&c[m].params["*"]!==v.params["*"];return g==="assets"?u.filter((v,m)=>p(v,m)||j(v,m)):g==="data"?u.filter((v,m)=>{let w=s.routes[v.route.id];if(!w||!w.hasLoader)return!1;if(p(v,m)||j(v,m))return!0;if(v.route.shouldRevalidate){let R=v.route.shouldRevalidate({currentUrl:new URL(d.pathname+d.search+d.hash,window.origin),currentParams:c[0]?.params||{},nextUrl:new URL(l,window.origin),nextParams:v.params,defaultShouldRevalidate:!0});if(typeof R=="boolean")return R}return!0}):[]}function Bv(l,u,{includeHydrateFallback:c}={}){return Nv(l.map(s=>{let d=u.routes[s.route.id];if(!d)return[];let g=[d.module];return d.clientActionModule&&(g=g.concat(d.clientActionModule)),d.clientLoaderModule&&(g=g.concat(d.clientLoaderModule)),c&&d.hydrateFallbackModule&&(g=g.concat(d.hydrateFallbackModule)),d.imports&&(g=g.concat(d.imports)),g}).flat(1))}function Nv(l){return[...new Set(l)]}function kv(l){let u={},c=Object.keys(l).sort();for(let s of c)u[s]=l[s];return u}function Uv(l,u){let c=new Set;return new Set(u),l.reduce((s,d)=>{let g=JSON.stringify(kv(d));return c.has(g)||(c.add(g),s.push({key:g,link:d})),s},[])}function Km(){let l=M.useContext(gl);return Mc(l,"You must render this element inside a <DataRouterContext.Provider> element"),l}function Hv(){let l=M.useContext(cu);return Mc(l,"You must render this element inside a <DataRouterStateContext.Provider> element"),l}var Dc=M.createContext(void 0);Dc.displayName="FrameworkContext";function Jm(){let l=M.useContext(Dc);return Mc(l,"You must render this element inside a <HydratedRouter> element"),l}function Gv(l,u){let c=M.useContext(Dc),[s,d]=M.useState(!1),[g,p]=M.useState(!1),{onFocus:j,onBlur:v,onMouseEnter:m,onMouseLeave:w,onTouchStart:R}=u,D=M.useRef(null);M.useEffect(()=>{if(l==="render"&&p(!0),l==="viewport"){let L=U=>{U.forEach($=>{p($.isIntersecting)})},X=new IntersectionObserver(L,{threshold:.5});return D.current&&X.observe(D.current),()=>{X.disconnect()}}},[l]),M.useEffect(()=>{if(s){let L=setTimeout(()=>{p(!0)},100);return()=>{clearTimeout(L)}}},[s]);let H=()=>{d(!0)},G=()=>{d(!1),p(!1)};return c?l!=="intent"?[g,D,{}]:[g,D,{onFocus:mi(j,H),onBlur:mi(v,G),onMouseEnter:mi(m,H),onMouseLeave:mi(w,G),onTouchStart:mi(R,H)}]:[!1,D,{}]}function mi(l,u){return c=>{l&&l(c),c.defaultPrevented||u(c)}}function Lv({page:l,...u}){let{router:c}=Km(),s=M.useMemo(()=>Um(c.routes,l,c.basename),[c.routes,l,c.basename]);return s?M.createElement(qv,{page:l,matches:s,...u}):null}function Yv(l){let{manifest:u,routeModules:c}=Jm(),[s,d]=M.useState([]);return M.useEffect(()=>{let g=!1;return Cv(l,u,c).then(p=>{g||d(p)}),()=>{g=!0}},[l,u,c]),s}function qv({page:l,matches:u,...c}){let s=gn(),{manifest:d,routeModules:g}=Jm(),{basename:p}=Km(),{loaderData:j,matches:v}=Hv(),m=M.useMemo(()=>am(l,u,v,d,s,"data"),[l,u,v,d,s]),w=M.useMemo(()=>am(l,u,v,d,s,"assets"),[l,u,v,d,s]),R=M.useMemo(()=>{if(l===s.pathname+s.search+s.hash)return[];let G=new Set,L=!1;if(u.forEach(U=>{let $=d.routes[U.route.id];!$||!$.hasLoader||(!m.some(Q=>Q.route.id===U.route.id)&&U.route.id in j&&g[U.route.id]?.shouldRevalidate||$.hasClientLoader?L=!0:G.add(U.route.id))}),G.size===0)return[];let X=Mv(l,p,"data");return L&&G.size>0&&X.searchParams.set("_routes",u.filter(U=>G.has(U.route.id)).map(U=>U.route.id).join(",")),[X.pathname+X.search]},[p,j,s,d,m,u,l,g]),D=M.useMemo(()=>Bv(w,d),[w,d]),H=Yv(w);return M.createElement(M.Fragment,null,R.map(G=>M.createElement("link",{key:G,rel:"prefetch",as:"fetch",href:G,...c})),D.map(G=>M.createElement("link",{key:G,rel:"modulepreload",href:G,...c})),H.map(({key:G,link:L})=>M.createElement("link",{key:G,...L})))}function Vv(...l){return u=>{l.forEach(c=>{typeof c=="function"?c(u):c!=null&&(c.current=u)})}}var $m=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{$m&&(window.__reactRouterVersion="7.7.1")}catch{}function Xv({basename:l,children:u,window:c}){let s=M.useRef();s.current==null&&(s.current=Dy({window:c,v5Compat:!0}));let d=s.current,[g,p]=M.useState({action:d.action,location:d.location}),j=M.useCallback(v=>{M.startTransition(()=>p(v))},[p]);return M.useLayoutEffect(()=>d.listen(j),[d,j]),M.createElement(xv,{basename:l,children:u,location:g.location,navigationType:g.action,navigator:d})}var Wm=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Oc=M.forwardRef(function({onClick:u,discover:c="render",prefetch:s="none",relative:d,reloadDocument:g,replace:p,state:j,target:v,to:m,preventScrollReset:w,viewTransition:R,...D},H){let{basename:G}=M.useContext(Ut),L=typeof m=="string"&&Wm.test(m),X,U=!1;if(typeof m=="string"&&L&&(X=m,$m))try{let _e=new URL(window.location.href),at=m.startsWith("//")?new URL(_e.protocol+m):new URL(m),it=hn(at.pathname,G);at.origin===_e.origin&&it!=null?m=it+at.search+at.hash:U=!0}catch{kt(!1,`<Link to="${m}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let $=lv(m,{relative:d}),[Q,ae,Z]=Gv(s,D),le=Jv(m,{replace:p,state:j,target:v,preventScrollReset:w,relative:d,viewTransition:R});function W(_e){u&&u(_e),_e.defaultPrevented||le(_e)}let we=M.createElement("a",{...D,...Z,href:X||$,onClick:U||g?u:W,ref:Vv(H,ae),target:v,"data-discover":!L&&c==="render"?"true":void 0});return Q&&!L?M.createElement(M.Fragment,null,we,M.createElement(Lv,{page:$})):we});Oc.displayName="Link";var Qv=M.forwardRef(function({"aria-current":u="page",caseSensitive:c=!1,className:s="",end:d=!1,style:g,to:p,viewTransition:j,children:v,...m},w){let R=_i(p,{relative:m.relative}),D=gn(),H=M.useContext(cu),{navigator:G,basename:L}=M.useContext(Ut),X=H!=null&&Iv(R)&&j===!0,U=G.encodeLocation?G.encodeLocation(R).pathname:R.pathname,$=D.pathname,Q=H&&H.navigation&&H.navigation.location?H.navigation.location.pathname:null;c||($=$.toLowerCase(),Q=Q?Q.toLowerCase():null,U=U.toLowerCase()),Q&&L&&(Q=hn(Q,L)||Q);const ae=U!=="/"&&U.endsWith("/")?U.length-1:U.length;let Z=$===U||!d&&$.startsWith(U)&&$.charAt(ae)==="/",le=Q!=null&&(Q===U||!d&&Q.startsWith(U)&&Q.charAt(U.length)==="/"),W={isActive:Z,isPending:le,isTransitioning:X},we=Z?u:void 0,_e;typeof s=="function"?_e=s(W):_e=[s,Z?"active":null,le?"pending":null,X?"transitioning":null].filter(Boolean).join(" ");let at=typeof g=="function"?g(W):g;return M.createElement(Oc,{...m,"aria-current":we,className:_e,ref:w,style:at,to:p,viewTransition:j},typeof v=="function"?v(W):v)});Qv.displayName="NavLink";var Zv=M.forwardRef(({discover:l="render",fetcherKey:u,navigate:c,reloadDocument:s,replace:d,state:g,method:p=Wr,action:j,onSubmit:v,relative:m,preventScrollReset:w,viewTransition:R,...D},H)=>{let G=Fv(),L=Pv(j,{relative:m}),X=p.toLowerCase()==="get"?"get":"post",U=typeof j=="string"&&Wm.test(j),$=Q=>{if(v&&v(Q),Q.defaultPrevented)return;Q.preventDefault();let ae=Q.nativeEvent.submitter,Z=ae?.getAttribute("formmethod")||p;G(ae||Q.currentTarget,{fetcherKey:u,method:Z,navigate:c,replace:d,state:g,relative:m,preventScrollReset:w,viewTransition:R})};return M.createElement("form",{ref:H,method:X,action:L,onSubmit:s?v:$,...D,"data-discover":!U&&l==="render"?"true":void 0})});Zv.displayName="Form";function Kv(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Fm(l){let u=M.useContext(gl);return Me(u,Kv(l)),u}function Jv(l,{target:u,replace:c,state:s,preventScrollReset:d,relative:g,viewTransition:p}={}){let j=Xm(),v=gn(),m=_i(l,{relative:g});return M.useCallback(w=>{if(wv(w,u)){w.preventDefault();let R=c!==void 0?c:Si(v)===Si(m);j(l,{replace:R,state:s,preventScrollReset:d,relative:g,viewTransition:p})}},[v,j,m,c,s,u,l,d,g,p])}var $v=0,Wv=()=>`__${String(++$v)}__`;function Fv(){let{router:l}=Fm("useSubmit"),{basename:u}=M.useContext(Ut),c=mv();return M.useCallback(async(s,d={})=>{let{action:g,method:p,encType:j,formData:v,body:m}=Rv(s,u);if(d.navigate===!1){let w=d.fetcherKey||Wv();await l.fetch(w,c,d.action||g,{preventScrollReset:d.preventScrollReset,formData:v,body:m,formMethod:d.method||p,formEncType:d.encType||j,flushSync:d.flushSync})}else await l.navigate(d.action||g,{preventScrollReset:d.preventScrollReset,formData:v,body:m,formMethod:d.method||p,formEncType:d.encType||j,replace:d.replace,state:d.state,fromRouteId:c,flushSync:d.flushSync,viewTransition:d.viewTransition})},[l,u,c])}function Pv(l,{relative:u}={}){let{basename:c}=M.useContext(Ut),s=M.useContext(Qt);Me(s,"useFormAction must be used inside a RouteContext");let[d]=s.matches.slice(-1),g={..._i(l||".",{relative:u})},p=gn();if(l==null){g.search=p.search;let j=new URLSearchParams(g.search),v=j.getAll("index");if(v.some(w=>w==="")){j.delete("index"),v.filter(R=>R).forEach(R=>j.append("index",R));let w=j.toString();g.search=w?`?${w}`:""}}return(!l||l===".")&&d.route.index&&(g.search=g.search?g.search.replace(/^\?/,"?index&"):"?index"),c!=="/"&&(g.pathname=g.pathname==="/"?c:dn([c,g.pathname])),Si(g)}function Iv(l,{relative:u}={}){let c=M.useContext(Ym);Me(c!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:s}=Fm("useViewTransitionState"),d=_i(l,{relative:u});if(!c.isTransitioning)return!1;let g=hn(c.currentLocation.pathname,s)||c.currentLocation.pathname,p=hn(c.nextLocation.pathname,s)||c.nextLocation.pathname;return au(d.pathname,p)!=null||au(d.pathname,g)!=null}const ex="/assets/logo-Hzr1jdtX.png",tx=y.nav`
  background: #fff;
...
`;function Lo({icon:l,title:u,description:c,packages:s,buttonHref:d,buttonText:g}){return o.jsxs(u2,{children:[o.jsx(s2,{children:l}),o.jsx(o2,{children:u}),o.jsx(c2,{children:c}),o.jsx(f2,{children:s.map((p,j)=>o.jsxs("div",{children:[p,j<s.length-1&&o.jsx("br",{})]},j))}),o.jsx(d2,{href:d,children:g})]})}const h2=y.div`
  display: grid;
...
`,x2=y.p`
  ...
  margin-right: auto;
`,S2=y.section`
  background: url("${Bc("herren",4)}") center/cover;
  min-height: 400px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`;function lS(){return o.jsxs(o.Fragment,{children:[o.jsx(S2,{children:o.jsxs(w2,{children:[o.jsx(j2,{children:"SC Konstanz-Wollmatingen"}),o.jsx(_2,{children:"Werden Sie Teil unserer Erfolgsgeschichte"}),o.jsxs(z2,{children:[o.jsx(lm,{href:"#sponsoring-kategorien",children:"Sponsoring-Übersicht"}),o.jsx(lm,{href:"#kontakt",secondary:!0,children:"Kontakt aufnehmen"})]})]})}),o.jsxs(E2,{children:[o.jsx(pi,{id:"sponsoring-kategorien",children:"Sponsoring-Möglichkeiten"}),o.jsx(T2,{children:o.jsx(A2,{children:"Finden Sie das perfekte Sponsoring-Paket für Ihr Unternehmen. Von exklusiven Premium-Partnerschaften bis hin zu lokalen Werbemöglichkeiten – bei uns ist für jeden das Richtige dabei."})}),o.jsxs("section",{"aria-labelledby":"sponsor-categories-heading",children:[o.jsx(q2,{id:"sponsor-categories-heading",children:"Sponsoring-Kategorien Übersicht"}),o.jsxs(r2,{role:"region","aria-label":"Sponsoring-Kategorien",children:[o.jsx(Lo,{icon:"🏆",title:"Premium-Partnerschaften",description:"Exklusive Sponsoring-Möglichkeiten für Großunternehmen ab 5.000€",packages:["• Hauptsponsor (15.000€)","• Stadionpartner (12.000€)","• Co-Sponsor (9.500€)"],buttonHref:"#premium-pakete",buttonText:"Premium-Pakete ansehen"}),o.jsx(Lo,{icon:"🏢",title:"Lokale Werbung",description:"Sichtbarkeit bei Heimspielen und lokale Präsenz ab 800€",packages:["• SILBER-Paket (5.000€)","• Bandenwerbung (800€)","• Community-Partner (2.000€)"],buttonHref:"#lokale-pakete",buttonText:"Lokale Pakete ansehen"}),o.jsx(Lo,{icon:"🌟",title:"Starter & Spenden",description:"Einfacher Einstieg in die Vereinsförderung ab 150€",packages:["• Ballspende (150€)","• Ballspende 5er Pack (500€)","• Platz-Renovierung Spende (ab 100€)"],buttonHref:"#starter-pakete",buttonText:"Starter-Pakete ansehen"})]})]}),o.jsxs("section",{"aria-labelledby":"premium-pakete",children:[o.jsx(pi,{id:"premium-pakete",children:"Premium-Sponsoring-Pakete"}),o.jsx(Go,{packages:Ho.filter(l=>l.price==="15.000 €/Jahr"||l.price==="12.000 €/Jahr"||l.price==="9.500 €/Jahr")})]}),o.jsxs("section",{"aria-labelledby":"lokale-pakete",children:[o.jsx(pi,{id:"lokale-pakete",children:"Lokale Werbemöglichkeiten"}),o.jsx(Go,{packages:Ho.filter(l=>l.price==="5.000 €/Jahr"||l.price==="800 €/Jahr"||l.price==="2.000 €/Jahr")})]}),o.jsxs("section",{"aria-labelledby":"starter-pakete",children:[o.jsx(pi,{id:"starter-pakete",children:"Starter & Spenden-Optionen"}),o.jsx(Go,{packages:Ho.filter(l=>l.price==="150 €/pro Spiel"||l.price==="500 €/5 Spiele"||l.price.includes("Ab 100"))}),o.jsxs(V2,{children:[o.jsx(X2,{children:"⚽ Ballspende-Beispiel ansehen"}),o.jsx(Q2,{children:"Schauen Sie sich an, wie eine Ballspende mit Ihrem Logo aussehen könnte."}),o.jsx(Z2,{href:"/ballspende.png",target:"_blank",rel:"noopener noreferrer",children:"📸 Beispielbild öffnen"})]})]}),o.jsxs(R2,{children:[o.jsx(M2,{children:"Warum SC Konstanz-Wollmatingen?"}),o.jsxs(D2,{children:[o.jsxs(im,{children:[o.jsx(rm,{children:"📊 Erreichte Reichweite"}),o.jsxs(um,{children:[o.jsx("li",{children:"15+ Heimspiele pro Saison"}),o.jsx("li",{children:"200+ Zuschauer pro Spiel"}),o.jsx("li",{children:"2.500+ Instagram Follower"}),o.jsx("li",{children:"5.000+ monatliche Website-Besucher"})]})]}),o.jsxs(im,{children:[o.jsx(rm,{children:"🏆 Sportlicher Erfolg"}),o.jsxs(um,{children:[o.jsx("li",{children:"1. Damenmannschaft in Landesliga"}),o.jsx("li",{children:"2. Mannschaften pro Abteilung"}),o.jsx("li",{children:"Cheerleading-Team aktiv"}),o.jsx("li",{children:"Jugendförderung etabliert"})]})]})]})]}),o.jsx(pi,{children:"Zusätzliche Werbemöglichkeiten"}),o.jsxs(O2,{children:[o.jsx(C2,{children:'Werbung im Stadionmagazin „Heimspiel"'}),o.jsxs(B2,{children:[o.jsxs(N2,{children:[o.jsxs(Vo,{children:[o.jsx(Xo,{children:"1 Seite (Farbe)"}),o.jsx(Qo,{children:"1.000 €"}),o.jsx(Zo,{children:"DIN A4 (297 × 210 mm)"})]}),o.jsxs(Vo,{children:[o.jsx(Xo,{children:"1/2 Seite (Farbe)"}),o.jsx(Qo,{children:"500 €"}),o.jsx(Zo,{children:"DIN A5 (148 × 210 mm)"})]}),o.jsxs(Vo,{children:[o.jsx(Xo,{children:"1/4 Seite (Farbe)"}),o.jsx(Qo,{children:"250 €"}),o.jsx(Zo,{children:"DIN A6 (105 × 148 mm)"})]})]}),o.jsx(k2,{children:o.jsxs(U2,{children:[o.jsxs(Yo,{children:[o.jsx(qo,{}),"15 Ausgaben pro Saison"]}),o.jsxs(Yo,{children:[o.jsx(qo,{}),"ca. 100 Exemplare pro Heimspiel"]}),o.jsxs(Yo,{children:[o.jsx(qo,{}),"Digitale Version (Social Media & Website)"]})]})})]}),o.jsxs(H2,{children:[o.jsx(G2,{children:"📖 Aktuelle Ausgabe als Beispiel"}),o.jsx(L2,{children:"Schauen Sie sich die letzte Ausgabe unseres Stadionmagazins an und sehen Sie, wie Ihre Werbung wirken könnte."}),o.jsx(Y2,{href:"/StadionMagazin.pdf",target:"_blank",rel:"noopener noreferrer",children:"📄 Aktuelle Ausgabe öffnen (PDF)"})]})]}),o.jsxs(K2,{children:[o.jsx(J2,{children:"Werbeflächen auf dem Vereinsbus"}),o.jsx($2,{children:"Unser Vereinsbus ist jede Woche in Konstanz, im Landkreis und bei Auswärtsspielen unterwegs – ein idealer Ort für Ihre Werbung! Unterstützen Sie den SC Konstanz-Wollmatingen und profitieren Sie von lokaler Sichtbarkeit."}),o.jsxs(W2,{children:[o.jsxs(sm,{children:[o.jsx(om,{children:"Premium-Flächen"}),o.jsxs(cm,{children:[o.jsx("thead",{children:o.jsxs("tr",{children:[o.jsx("th",{children:"Position"}),o.jsx("th",{children:"Sichtbarkeit"}),o.jsx("th",{children:"Preis / Jahr"})]})}),o.jsxs("tbody",{children:[o.jsxs("tr",{children:[o.jsx("td",{children:"Heckfläche (100×80 cm)"}),o.jsx("td",{children:"Sehr hoch"}),o.jsx("td",{children:"1.200 €"})]}),o.jsxs("tr",{children:[o.jsx("td",{children:"Seitentüren (links/rechts)"}),o.jsx("td",{children:"Hoch"}),o.jsx("td",{children:"je 900 €"})]}),o.jsxs("tr",{children:[o.jsx("td",{children:"Hintere Seitenflächen"}),o.jsx("td",{children:"Mittel–hoch"}),o.jsx("td",{children:"je 600 €"})]})]})]})]}),o.jsxs(sm,{children:[o.jsx(om,{children:"Standard-Flächen"}),o.jsxs(cm,{children:[o.jsx("thead",{children:o.jsxs("tr",{children:[o.jsx("th",{children:"Position"}),o.jsx("th",{children:"Sichtbarkeit"}),o.jsx("th",{children:"Preis / Jahr"})]})}),o.jsxs("tbody",{children:[o.jsxs("tr",{children:[o.jsx("td",{children:"Fensterstreifen (15 cm Höhe)"}),o.jsx("td",{children:"Mittel"}),o.jsx("td",{children:"400 € je Seite"})]}),o.jsxs("tr",{children:[o.jsx("td",{children:"Frontstoßstange"}),o.jsx("td",{children:"Gering–mittel"}),o.jsx("td",{children:"250 €"})]})]})]})]})]}),o.jsxs(F2,{children:[o.jsx(P2,{children:"Zusatzoptionen:"}),o.jsxs(I2,{children:[o.jsx("li",{children:"Mehrjahresrabatt: 10 % (2 Jahre), 15 % (3 Jahre)"}),o.jsx("li",{children:"Kombi-Paket Online + Bus: +150 € für Logo & Link auf partner.sckw.de"}),o.jsx("li",{children:"Design & Folierung: optionaler Kostenbeitrag (50–100 €)"})]})]}),o.jsxs(eS,{children:[o.jsx(tS,{children:"➡️ Interesse an einer Bus-Werbefläche?"}),o.jsx(nS,{children:"Kontaktieren Sie uns für verfügbare Plätze und Layoutvorschläge:"}),o.jsx(aS,{href:"mailto:sponsoring@sckw.de",children:"📧 sponsoring@sckw.de"})]})]}),o.jsx(Cx,{}),o.jsx(b2,{headline:"Bereit für eine Partnerschaft?",description:"Gemeinsam können wir Großartiges erreichen! Kontaktieren Sie uns für ein persönliches Gespräch über Ihre Sponsoring-Möglichkeiten beim SC Konstanz-Wollmatingen.",contactInfos:[{icon:"📧",title:"E-Mail",content:"sponsoring@sckw.de",isEmail:!0},{icon:"📍",title:"Adresse",content:`SC Konstanz-Wollmatingen e.V.
Schleyerweg 5
D-78467 Konstanz`},{icon:"💼",title:"Rechtliches",content:`Gemeinnütziger Verein
Spenden steuerlich absetzbar
Schnelle Abwicklung garantiert`}]}),o.jsx(Px,{})]}),o.jsx(Cc,{})]})}const iS=[{id:"tasty-kfz-mechaniker",title:"Kfz-Mechatroniker (m/w/d)",company:"Tasty Delivery GmbH",logo:"tasty.png",tags:["Vollzeit","Konstanz","Ausbildung möglich"],description:"Verstärke unser Team in der modernen Kfz-Werkstatt. Wir bieten eine abwechslungsreiche Tätigkeit mit modernster Technik und ein tolles Betriebsklima.",type:"Standard",isExample:!0},{id:"grafhardenberg-verkauf",title:"Verkaufsberater Audi (m/w/d)",company:"Audi Zentrum Singen - Graf Hardenberg GmbH",logo:"grafhardenberg.png",tags:["Vollzeit","Singen","Quereinsteiger willkommen"],description:"Werde Teil unseres erfolgreichen Verkaufsteams im Audi Zentrum Singen. Wir bieten eine strukturierte Einarbeitung und attraktive Verdienstmöglichkeiten.",type:"Boosted",isExample:!0},{id:"ricobet-marketing",title:"Marketing Manager (m/w/d)",company:"RicoBet Deutschland",logo:"ricobet.png",tags:["Vollzeit","Remote möglich","Berufserfahrung"],description:"Gestalte mit uns die Zukunft des digitalen Marketings. Kreativität, Datenanalyse und Teamwork stehen bei uns im Fokus.",type:"Standard",isExample:!0},{id:"logans-service",title:"Servicekraft Gastronomie (m/w/d)",company:"Logan's Linde Wollmatingen",logo:"logans.png",tags:["Teilzeit/Vollzeit","Konstanz","Flexible Zeiten"],description:"Unterstütze unser gastfreundliches Team in einem der beliebtesten Restaurants in Konstanz. Wir suchen motivierte Menschen mit Leidenschaft für Service.",type:"Basis",isExample:!0}],rS=y.section`
  background: url("${Bc("herren",1)}") center/cover;
  min-height: 400px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,c5=()=>{const l=VS;return{kabinen:{current:l.packages.kabinen.current,goal:l.packages.kabinen.goal,donors:l.packages.kabinen.donors},fassade:{current:l.packages.fassade.current,goal:l.packages.fassade.goal,donors:l.packages.fassade.donors},waschkueche:{current:l.packages.waschkueche.current,goal:l.packages.waschkueche.goal,donors:l.packages.waschkueche.donors}}};function f5({data:l=c5(),realTime:u=!1}){const[c,s]=M.useState(l),[d,g]=M.useState(new Date),[p,j]=M.useState(!1),v=async()=>{j(!0);try{const R=await fetch("https://raw.githubusercontent.com/BigPun86/sportclub/main/src/data/donationData.json",{cache:"no-cache",headers:{"Cache-Control":"no-cache, no-store, must-revalidate",Pragma:"no-cache"}});if(R.ok){const D=await R.json(),H={kabinen:{current:D.packages.kabinen.current,goal:D.packages.kabinen.goal,donors:D.packages.kabinen.donors},fassade:{current:D.packages.fassade.current,goal:D.packages.fassade.goal,donors:D.packages.fassade.donors},waschkueche:{current:D.packages.waschkueche.current,goal:D.packages.waschkueche.goal,donors:D.packages.waschkueche.donors}};s(H),g(new Date),console.log("✅ Spendendaten aktualisiert!")}}catch(R){console.error("❌ Fehler beim Laden der Spendendaten:",R)}finally{j(!1)}};M.useEffect(()=>{if(!u)return;const R=setInterval(()=>{v()},3e4);return()=>clearInterval(R)},[u]);const m=R=>{switch(R){case"kabinen":return"🔧";case"fassade":return"🎨";case"waschkueche":return"🧺";default:return"💰"}},w=R=>{switch(R){case"kabinen":return"Kabinen sanieren";case"fassade":return"Fassade & Fenster";case"waschkueche":return"Waschküche modernisieren";default:return R}};return o.jsxs(o.Fragment,{children:[o.jsx(XS,{children:Object.entries(c).map(([R,D])=>{const H=D.current/D.goal*100;return o.jsxs(QS,{children:[o.jsxs(ZS,{children:[m(R)," ",w(R)]}),o.jsxs(KS,{children:[o.jsxs(JS,{children:[o.jsxs("span",{children:[D.current.toLocaleString("de-DE")," €"]}),o.jsxs("span",{children:[D.goal.toLocaleString("de-DE")," €"]})]}),o.jsx($S,{children:o.jsx(WS,{$progress:H})}),o.jsxs(FS,{children:[Math.round(H),"% erreicht"]})]}),o.jsxs(PS,{children:[o.jsxs(IS,{children:["💝 Spender (",D.donors.length,")"]}),o.jsx(e5,{children:D.donors.length>0?D.donors.slice().reverse().map((G,L)=>o.jsxs(t5,{children:[o.jsxs(n5,{children:[o.jsx(a5,{children:G.anonymous?"Anonymer Spender":G.name}),G.comment&&o.jsxs(i5,{children:['"',G.comment,'"']}),G.date&&o.jsx(r5,{children:G.date})]}),o.jsxs(l5,{children:[G.amount.toLocaleString("de-DE")," €"]})]},L)):o.jsx(u5,{children:"Noch keine Spenden 🤗"})})]})]},R)})}),o.jsxs(s5,{onClick:v,disabled:p,title:"Spendendaten aktualisieren",children:["🔄",p?"Lade...":"Aktualisieren"]}),o.jsxs(o5,{children:["Letztes Update: ",d.toLocaleTimeString("de-DE")]})]})}const d5=y.section`
  background: url("${Bc("herren",18)}") center/cover;
  min-height: 400px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,P5=y.p`
  ...
  margin: 1.5rem 0 0 0;
  text-align: center;
`,rl=J0();function oc({images:l,onImageClick:u}){const[c,s]=M.useState(0);return M.useEffect(()=>{if(l.length<=1)return;const d=setInterval(()=>{s(g=>(g+1)%l.length)},4e3);return()=>clearInterval(d)},[l.length]),l.length===0?o.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%",color:"#64748b",fontSize:"0.9rem",textAlign:"center"},children:"📷 Bilder folgen bald"}):o.jsxs(w5,{children:[l.map((d,g)=>o.jsx(T5,{src:d.src,alt:d.alt,$isActive:g===c,onClick:()=>u(g)},g)),l.length>1&&o.jsx(A5,{children:l.map((d,g)=>o.jsx(R5,{$isActive:g===c,onClick:()=>s(g)},g))})]})}function I5({images:l,initialIndex:u,onClose:c}){const[s,d]=M.useState(u),g=M.useCallback(()=>{d(j=>(j+1)%l.length)},[l.length]),p=M.useCallback(()=>{d(j=>(j-1+l.length)%l.length)},[l.length]);return M.useEffect(()=>{const j=v=>{v.key==="Escape"&&c(),v.key==="ArrowRight"&&g(),v.key==="ArrowLeft"&&p()};return document.addEventListener("keydown",j),()=>document.removeEventListener("keydown",j)},[c,g,p]),o.jsx(M5,{onClick:c,children:o.jsxs(D5,{onClick:j=>j.stopPropagation(),children:[o.jsx(C5,{onClick:c,children:"×"}),o.jsx(O5,{src:l[s].src,alt:l[s].alt}),l.length>1&&o.jsxs(o.Fragment,{children:[o.jsx(dm,{$direction:"prev",onClick:p,children:"‹"}),o.jsx(dm,{$direction:"next",onClick:g,children:"›"})]})]})})}function e3(){const[l,u]=M.useState(!1),[c,s]=M.useState([]),[d,g]=M.useState(0),[p,j]=M.useState(!1),v=(R,D)=>{s(R),g(D),u(!0)},m=R=>{R.preventDefault(),j(!0)},w=()=>{navigator.clipboard.writeText("DE12 6905 0001 0000 0228 06")};return o.jsxs(o.Fragment,{children:[o.jsx(d5,{children:o.jsxs(h5,{children:[o.jsx(g5,{children:"🏟️ Fürstenberg weiterentwickeln"}),o.jsx(m5,{children:"Unser Kultplatz verdient es - gemeinsam machen wir den Charme noch besser"})]})}),o.jsxs(p5,{children:[o.jsxs(b5,{children:[o.jsx(y5,{children:"Der Fürstenberg - unser Kultplatz"}),o.jsx(v5,{children:"Der Fürstenberg ist mehr als ein Sportplatz - er ist das Herzstück unseres Vereins mit einer einzigartigen Atmosphäre und besonderem Charme. Dieser authentische Charakter macht ihn zu dem, was er ist: unser Zuhause."}),o.jsxs(x5,{children:[o.jsx(S5,{children:"✨ Charme erhalten, Komfort verbessern"}),o.jsx(j5,{children:"Wir möchten den besonderen Charakter des Fürstenberg bewahren und gleichzeitig einige Bereiche behutsam weiterentwickeln. Mit Ihrer Unterstützung können wir das Beste aus beiden Welten schaffen."})]})]}),o.jsxs(_5,{children:[o.jsx(z5,{children:"🔍 Wo wir ansetzen möchten"}),o.jsxs(E5,{children:[o.jsxs(Fo,{children:[o.jsx(Po,{children:o.jsx(oc,{images:rl.kabinen,onImageClick:R=>v(rl.kabinen,R)})}),o.jsx(Io,{children:"🔧 Kabinen komfortabler gestalten"}),o.jsx(ec,{children:"Die Kabinen haben schon viele Geschichten erlebt - nun möchten wir ihnen mit neuen Bänken, frischen Wänden und durchdachter Ausstattung mehr Komfort verleihen, ohne ihren authentischen Charakter zu verlieren."})]}),o.jsxs(Fo,{children:[o.jsx(Po,{children:o.jsx(oc,{images:rl.fassade,onImageClick:R=>v(rl.fassade,R)})}),o.jsx(Io,{children:"🎨 Fassade & Fenster erneuern"}),o.jsx(ec,{children:"Die Außenfassade hat ihren Dienst getan und möchte nun erneuert werden. Neue Fenster, frischer Putz und eine ansprechende Gestaltung werden dem Fürstenberg gut stehen - und bieten Raum für die Namen unserer Partner, die diesen Kultplatz unterstützen."})]}),o.jsxs(Fo,{children:[o.jsx(Po,{children:o.jsx(oc,{images:rl.waschkueche,onImageClick:R=>v(rl.waschkueche,R)})}),o.jsx(Io,{children:"🧺 Waschküche auf Vordermann bringen"}),o.jsx(ec,{children:"Unsere treuen Waschgeräte haben jahrelang gute Arbeit geleistet. Moderne, energieeffiziente Nachfolger würden nicht nur die Umwelt schonen, sondern auch die Pflege unserer Trikots optimieren."})]})]})]}),o.jsxs(B5,{children:[o.jsx(N5,{children:"✨ Unsere Pläne für den Fürstenberg"}),o.jsxs(k5,{children:[o.jsxs(tc,{children:[o.jsx(nc,{children:"🪑"}),o.jsx(ac,{children:"Kabinen sanieren"}),o.jsx(lc,{children:"Neue Bänke einbauen, Böden erneuern, Belüchtung modernisieren und eine freundliche Atmosphäre schaffen."}),o.jsx(ic,{children:"~8.000 €"})]}),o.jsxs(tc,{children:[o.jsx(nc,{children:"🎨"}),o.jsx(ac,{children:"Fassade & Fenster erneuern"}),o.jsx(lc,{children:"Putz erneuern, professionell streichen, neue Fenster einbauen, SCKW-Logo anbringen und Sponsoren-Namen prominent platzieren für maximale Sichtbarkeit."}),o.jsx(ic,{children:"~15.000 €"})]}),o.jsxs(tc,{children:[o.jsx(nc,{children:"🧺"}),o.jsx(ac,{children:"Waschküche modernisieren"}),o.jsx(lc,{children:"Die vorhandenen Geräte durch moderne, energieeffiziente Waschmaschine und Trockner ersetzen für eine optimale Pflege der Sportkleidung."}),o.jsx(ic,{children:"~5.000 €"})]})]})]}),o.jsxs(U5,{children:[o.jsx(H5,{children:"🤝 Werden Sie Renovierungs-Partner!"}),o.jsx(G5,{children:"Als Renovierungs-Sponsor erhalten Sie nicht nur steuerliche Vorteile, sondern auch prominent sichtbare Anerkennung direkt an unserem Sportplatz!"}),o.jsxs(L5,{children:[o.jsxs(qr,{children:[o.jsx(Vr,{children:"🏆"}),o.jsxs(Xr,{children:[o.jsx("strong",{children:"Namensschild an der Fassade:"})," Ihr Firmenname wird dauerhaft und gut sichtbar an der renovierten Außenfassade angebracht"]})]}),o.jsxs(qr,{children:[o.jsx(Vr,{children:"📄"}),o.jsxs(Xr,{children:[o.jsx("strong",{children:"Spendenquittung:"})," Alle Spenden sind steuerlich absetzbar - wir stellen Ihnen gerne eine Quittung aus"]})]}),o.jsxs(qr,{children:[o.jsx(Vr,{children:"📱"}),o.jsxs(Xr,{children:[o.jsx("strong",{children:"Social Media Dank:"})," Wir danken Ihnen öffentlich auf unseren Kanälen mit über 4.000 Followern"]})]}),o.jsxs(qr,{children:[o.jsx(Vr,{children:"🎯"}),o.jsxs(Xr,{children:[o.jsx("strong",{children:"Maximale Sichtbarkeit:"})," Die Fassade liegt direkt am Eingang - jeder Besucher sieht Ihren Namen"]})]})]})]}),o.jsxs(Y5,{children:[o.jsx(q5,{children:"🤝 Gemeinsam für den Fürstenberg"}),o.jsx(V5,{children:"Jeder Beitrag macht einen Unterschied. Ob 50€ oder 5.000€ - gemeinsam können wir unserem Kultplatz das geben, was er verdient."}),o.jsx(f5,{realTime:!0}),o.jsxs(X5,{children:[o.jsx(hm,{className:"primary",href:"https://www.paypal.com/donate/?hosted_button_id=NRFWJ3SGN37XW",target:"_blank",rel:"noopener noreferrer",children:"💳 Mit PayPal spenden"}),o.jsx(hm,{href:"#",onClick:m,children:"🏦 Per Überweisung spenden"})]})]})]}),o.jsx(Cc,{}),p&&o.jsx(Q5,{onClick:()=>j(!1),children:o.jsxs(Z5,{onClick:R=>R.stopPropagation(),children:[o.jsxs(K5,{children:[o.jsx(J5,{children:"Kontoverbindung für Spenden"}),o.jsx($5,{onClick:()=>j(!1),children:"×"})]}),o.jsxs(W5,{children:[o.jsxs(rc,{children:[o.jsx(uc,{children:"Kontoinhaber:"}),o.jsx(sc,{children:"SC Konstanz-Wollmatingen"})]}),o.jsxs(rc,{children:[o.jsx(uc,{children:"IBAN:"}),o.jsx(sc,{children:"DE12 6905 0001 0000 0228 06"})]}),o.jsxs(rc,{children:[o.jsx(uc,{children:"BIC:"}),o.jsx(sc,{children:"SOLADES1KNZ"})]})]}),o.jsx(F5,{onClick:w,children:"📋 IBAN kopieren"}),o.jsx(P5,{children:"Klicken Sie außerhalb dieses Fensters oder auf × zum Schließen"})]})}),l&&o.jsx(I5,{images:c,initialIndex:d,onClose:()=>u(!1)})]})}function t3(){return o.jsxs(Xv,{children:[o.jsx(sx,{}),o.jsxs(Sv,{children:[o.jsx(yi,{path:"/",element:o.jsx(vv,{to:"/sponsoring",replace:!0})}),o.jsx(yi,{path:"/sponsoring",element:o.jsx(lS,{})}),o.jsx(yi,{path:"/jobs",element:o.jsx(YS,{})}),o.jsx(yi,{path:"/renovierung",element:o.jsx(e3,{})})]})]})}const n3={colors:{primary:"#d9245f",primaryDark:"#b81d51",primaryLight:"#ff4b82",secondary:"#1696ff",secondaryDark:"#0e6ec0",secondaryLight:"#5ab8ff",text:"#222",textMuted:"#666",bg:"#fff",bgMuted:"#f8f9fa",border:"#e9ecef"}};console.log("sckw sponsoring Website loaded");Tb.createRoot(document.getElementById("root")).render(o.jsx(M.StrictMode,{children:o.jsx(Ay,{theme:n3,children:o.jsx(t3,{})})}));
