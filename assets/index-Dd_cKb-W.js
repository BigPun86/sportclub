...
`,e4=y.div`
  ...
  display: flex;
  justify-content: center;
`;function t4(){return r.jsxs(r.Fragment,{children:[r.jsx(I_,{}),r.jsx(e4,{children:r.jsx(G_,{})})]})}function n4(){const{pathname:a}=on();return C.useEffect(()=>{window.scrollTo(0,0)},[a]),null}function a4(){return r.jsxs($2,{children:[r.jsx(n4,{}),r.jsxs(x2,{children:[r.jsx(ln,{path:"/",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(Rs,{to:"/sponsoring",replace:!0})]})}),r.jsx(ln,{path:"/sponsoring",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(yw,{})]})}),r.jsx(ln,{path:"/sponsoring-handoff",element:r.jsx(Zw,{})}),r.jsx(ln,{path:"/widget",element:r.jsx(t4,{})}),r.jsx(ln,{path:"/sponsoring/club-500",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(g_,{})]})}),r.jsx(ln,{path:"/sponsoring/pakete",element:r.jsx(Rs,{to:"/sponsoring#angebot",replace:!0})}),r.jsx(ln,{path:"/sponsoring/spielerpatenschaft",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(b_,{})]})}),r.jsx(ln,{path:"/mockup-generator",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(d6,{})]})}),r.jsx(ln,{path:"/renovierung",element:r.jsxs(r.Fragment,{children:[r.jsx(zl,{}),r.jsx(Y5,{})]})}),r.jsx(ln,{path:"*",element:r.jsx(Rs,{to:"/sponsoring",replace:!0})})]})]})}console.log("sckw sponsoring Website loaded");Ay.createRoot(document.getElementById("root")).render(r.jsx(C.StrictMode,{children:r.jsx(zv,{theme:eo,children:r.jsx(a4,{})})}));
